layui.define(function (exports) {
    ...
    let Player = function (e) {
        ...
        return n.m = e, n.c = t, n.d = function (e, t, r) {
            ...
            if (n.r(r), Object.defineProperty(r, "default", {
                enumerable: !0,
                value: e
            }), 2 & t && "string" != typeof e) for (let a in e) n.d(r, a, function (t) {
                return e[t]
            }.bind(null, a));
            return r
        }, n.n = function (e) {
        ...
        let h = function (e) {
            function t(e) {
                ...
                let n = g(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
                ...
                if (i.default.addClass(n.root, "xgplayer xgplayer-" + l.default.device + " xgplayer-nostart " + (n.config.controls ? "" : "no-controls")), n.root.appendChild(n.controls), n.config.fluid ? (n.root.style["max-width"] = "100%", n.root.style.width = "100%", n.root.style.height = "0", n.root.style["padding-top"] = 100 * n.config.height / n.config.width + "%", n.video.style.position = "absolute", n.video.style.top = "0", n.video.style.left = "0") : (n.config.width && ("number" != typeof n.config.width ? n.root.style.width = n.config.width : n.root.style.width = n.config.width + "px"), n.config.height && ("number" != typeof n.config.height ? n.root.style.height = n.config.height : n.root.style.height = n.config.height + "px")), n.config.execBeforePluginsCall && n.config.execBeforePluginsCall.forEach(function (e) {
                    ...
                    fetch(a.config.controlStyle, {
                        ...
                        e.ok && e.json().then(function (e) {
                            for (let t in e) e.hasOwnProperty(t) && (a.config[t] = e[t]);
                            a.pluginsCall()
                        })
                    }).catch(function (e) {
            ...
            return function (e, t) {
                ...
                key: "start", value: function () {
                    let e = this, n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.config.url,
                        r = this.root, a = this;
                ...
                key: "destroy", value: function () {
                    let e = this, n = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0], r = this;
                    this.root.parentNode;
                    for (let a in clearInterval(this.bulletResizeTimer), this._interval) clearInterval(this._interval[a]), this._interval[a] = null;

                    function i() {
                        for (let e in this.emit("destroy"), this.video.removeAttribute("src"), this.video.load(), n && (this.root.innerHTML = "", this.root.className = ""), this) delete this[e];
                        this.off("pause", i)
                    }

                    this.ev.forEach(function (t) {
                        let n = Object.keys(t)[0], r = e[t[n]];
                        r && e.off(n, r)
                ...
                key: "download", value: function () {
                    let e = (0, c.getAbsoluteURL)(player.config.url);
                ...
                key: "getPIP", value: function () {
                    let e = i.default.createDom("xg-pip-lay", "<div></div>", {}, "xgplayer-pip-lay");
                    this.root.appendChild(e);
                    let t = i.default.createDom("xg-pip-drag", '<div class="drag-handle"><span>点击按住可拖动视频</span></div>', {tabindex: 9}, "xgplayer-pip-drag");
                ...
                key: "exitPIP", value: function () {
                    ...
                    let e = i.default.findDom(this.root, ".xgplayer-pip-lay");
                    e && e.parentNode && e.parentNode.removeChild(e);
                    let t = i.default.findDom(this.root, ".xgplayer-pip-drag");
                    t && t.parentNode && t.parentNode.removeChild(t)
                }
            }, {
                key: "updateRotateDeg", value: function () {
                    player.rotateDeg || (player.rotateDeg = 0);
                    let e = player.root.offsetWidth, t = player.root.offsetHeight, n = player.video.videoWidth,
                ...
                key: "onKeydown", value: function (e, t) {
                    ...
                    if (!n || 37 !== n.keyCode && 38 !== n.keyCode && 39 !== n.keyCode && 40 !== n.keyCode && 32 !== n.keyCode || t.emit("focus"), !n || 40 !== n.keyCode && 38 !== n.keyCode) n && 39 === n.keyCode ? t.currentTime + 10 <= t.duration ? t.currentTime += 10 : t.currentTime = t.duration - 1 : n && 37 === n.keyCode ? t.currentTime - 10 >= 0 ? t.currentTime -= 10 : t.currentTime = 0 : n && 32 === n.keyCode && (t.paused ? t.play() : t.pause()); else {
                        if (t.controls) {
                            let r = t.controls.querySelector(".xgplayer-slider");
        ...
        let util = {
            createDom: function () {
                ...
                let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : document, t = arguments[1],
                    n = void 0;
                try {
                    n = e.querySelector(t)
                } catch (r) {
                ...
                for (let r = String(n), a = t >> 0, i = Math.ceil(a / r.length), o = [], l = String(e); i--;) o.push(r);
                return o.join("").substring(0, a - l.length) + l
            }, format: function (e) {
                if (window.isNaN(e)) return "";
                let t = util.padStart(Math.floor(e / 3600), 2, 0),
                ...
                let t = (e.currentStyle || window.getComputedStyle(e, null)).backgroundImage;
                if (!t || "none" === t) return "";
                let n = document.createElement("a");
                return n.href = t.replace(/url\("|"\)/g, ""), n.href
            }, copyDom: function (e) {
                if (e && 1 === e.nodeType) {
                    let t = document.createElement(e.tagName);
                ...
                let a = util.createDom("xg-" + e, "", {}, "xgplayer-" + e + "-img");
                if (a.style.backgroundImage = 'url("' + t + '")', n && r) {
                    let i = void 0, o = void 0, l = void 0;
        ...
        t.default = function e(t, n, i, o, l, s, u, c) {
            let p = arguments.length > 8 && void 0 !== arguments[8] ? arguments[8] : {
                line: "",
                handle: "",
                msg: "",
                version: ""
        ...
        let r = {
            get device() {
                ...
                let e = navigator.userAgent.toLowerCase(), t = {
                    ie: /rv:([\d.]+)\) like gecko/,
                    firfox: /firefox\/([\d.]+)/,
                    chrome: /chrome\/([\d.]+)/,
                    opera: /opera.([\d.]+)/,
                ...
                let e = navigator.userAgent, t = /(?:Windows Phone)/.test(e), n = /(?:SymbianOS)/.test(e) || t,
        ...
        let i = void 0, o = function e() {
                ...
                !function (e, t) {
                    ...
                    let e = {user: {}, header: {headers: {custom: {}}}}, n = t.envInfo, r = n.user, o = Object.keys(r),
                    ...
                    let p = n.header, d = Object.keys(p), f = Array.isArray(d), g = 0;
                    ...
                    let x = n.header.headers, m = Object.keys(x), v = Array.isArray(m), b = 0;
                    ...
                    let _ = n.header.headers.custom, E = Object.keys(_);
                    if (E.length) {
                        let C = E, S = Array.isArray(C), P = 0;
        ...
        for (let _, E, C = /Mobile|htc|mini|Android|iP(ad|od|hone)/.test(p) ? "wap" : "web", S = [{
            s: "Windows 10",
        ...
        let L = {
                ...
                get: function (e) {
                    let t = localStorage.getItem(e), n = t;
                    try {
        ...
        let q = function e() {
            let t = this, n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "";
            !function (e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, e), this.init = function (e) {
                t.isLog = e
            }, this.info = function (e) {
                for (let n = arguments.length, r = Array(n > 1 ? n - 1 : 0), a = 1; a < n; a++) r[a - 1] = arguments[a];
                let i;
        ...
        let H = (new Date).getTimezoneOffset(), W = parseInt(-H / 60, 10), Y = 60 * H, V = void 0;
        try {
            V = "3.2.7"
        } catch (_) {
            V = "2.x"
        }
        let K = new (function (e) {
            function t() {
                !function (e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, t);
        ...
        let J = function (e) {
            return function (e, t, n) {
                if ("string" == typeof e && "number" == typeof t && "number" == typeof n) {
                    let r, a = [];
                    n = n <= 25 ? n : n % 25;
                    let i = String.fromCharCode(n + 97);
                    r = e.split(i);
                    for (let o = 0; o < r.length; o++) {
                        let l = parseInt(r[o], n);
                        l = 1 * l ^ t;
                        let s = String.fromCharCode(l);
                        a.push(s)
                    }
                    return a.join("")
                }
        ...
        let Z = {
            ...
            function t() {
                ...
                return n.init = function (e) {
                    let t = e.app_id, r = e.channel, a = e.log, i = e.channel_domain, o = e.name;
                    ...
                    let t = e.app_id, r = e.disable_ssid, a = e.disable_webid, i = e.disable_sdk_monitor;
                    ...
                    let e = n.tokensCacheKey, t = ee("tt_webid"), r = ee("__tea_sdk__ssid"),
                        a = ee("__tea_sdk__user_unique_id");
                    if (X.isLowIE()) {
                        if (t) {
                            let i = {web_id: t, ssid: t, user_unique_id: t};
                            D.set(e, JSON.stringify(i))
                        }
                        return !1
                    }
                    if (t && r && a) {
                        let o = {web_id: t, ssid: r, user_unique_id: a};
                    ...
                    let r = n.purifyBlackUuid(n.getUserTokens());
                    ...
                    let t = e.web_id, r = e.ssid, a = e.user_unique_id;
                    n.setUserTokens({web_id: t, ssid: r, user_unique_id: a})
                }, n.requestWebId = function () {
                    n.isRequestWebId = !0;
                    let e = function (e) {
                        let t = n.envInfo.user.web_id || e.web_id, r = e.ssid;
                    ...
                    n.isWebidDisabled ? e({web_id: Q(), ssid: ""}) : function () {
                        let t = n.userTokensPrefix + "/v1/user/webid";
                        U(t, {
                            app_id: n.app_id,
                            url: location.href,
                    ...
                    if (r.user_unique_id === n.realUuid && r.ssid && r.web_id) n.logger.info("传入的 user_id/user_unique_id 与 缓存中的完全一致，无需再次请求"), n.unlock(); else {
                        ...
                        let a = G({}, n.getUserTokens(), {user_unique_id: n.realUuid});
                    ...
                    let e = n.getUserTokens(), t = n.userTokensPrefix + "/v1/user/ssid";
                    ...
                    let t = n.mergeEnv(), r = [], a = 0, i = void 0;
                    return e.forEach(function (e) {
                        let t = !!e.params.__disable_storage__;
                        void 0 === i ? i = t : (t !== i || r[a].length >= 5) && (a += 1, i = !i), r[a] = r[a] || [], r[a].push(e)
                    }), r.map(function (e) {
                        return {
                            events: e.map(function (e) {
                                let t = G({}, n.evtParams, e.params);
                    ...
                    let e = n.get(), t = K.get(), r = G({}, e.user),
        ...
        let ae = function () {
            function e(t) {
                let n = t.disable_storage, r = void 0 !== n && n;
                !function (e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            ...
            return e.prototype.setStorageKey = function (e) {
                ...
                if (void 0 === this._data) try {
                    let e, t = this._getDataFromStorage();
            ...
            try {
                ...
                t.forEach(function (e) {
                    let t = function (e) {
                        let t = "";
                        for (let n in e) e.hasOwnProperty(n) && (t += "&" + n + "=" + encodeURIComponent(JSON.stringify(e[n])));
        ...
        let se = function e(t) {
            ...
            !function (e, t) {
                ...
                let t = e.url, r = e.data, a = e.success, i = e.fail, o = e.eventError;
                if (function (e) {
                    let t = e.url, n = e.data, r = e.success, a = e.fail, i = e.notSure, o = e.isUnload, l = n;
        ...
        let pe = function (e) {
            function t(n) {
                ...
                a.addListener = function () {
                    ...
                    let t = re.get(a.evtDataCacheKey) || [];
                    re.clean(a.evtDataCacheKey);
                    let n = a.mergeEnvToEvents(t);
                    a.sendData(n, e)
                }, a.sendData = function (e, t) {
                    let n = [], r = 0, i = void 0;
                    e.forEach(function (e) {
                        let t = !!e.__disable_storage__;
                    ...
                    let e = a.eventStorage.getData(), t = Object.keys(e);
                ...
                let i = n.log, o = n.disable_storage, l = n.max_batch_num, s = void 0 === l ? 5 : l, u = n.batch_time,
                    c = void 0 === u ? 30 : u;
        ...
        let fe = function () {
            let e = +Date.now() + Number(("" + Math.random()).slice(2, 8));
            return function () {
                return e += 1
            }
        }(), ge = function e(t) {
            ...
            !function (e, t) {
                ...
                for (let e = arguments.length, t = Array(e), r = 0; r < e; r++) t[r] = arguments[r];
                let a = X.isBoolean(t[t.length - 1]), i = !!a && t[t.length - 1], o = a ? t.slice(0, t.length - 1) : t,
                    l = o[0], s = [];
        ...
        t.default = function e(t) {
            ...
            return function (e, t) {
                ...
                if (0 !== n.cmdQueue.length) {
                    let e, t, r, a, i = (e = n.cmdQueue, t = "init", r = "0", a = -1, e.forEach(function (e, n) {
        ...
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0});
        let r = _(n(0)), a = _(n(34)), i = _(n(35)), o = _(n(36)), l = _(n(37)), s = _(n(38)), u = _(n(39)),
            c = _(n(40)),
        ...
        let s = function () {
            function e(t) {
                ...
                if (t.textTrack && Array.isArray(t.textTrack) && (navigator.userAgent.indexOf("Chrome") > -1 || navigator.userAgent.indexOf("Firefox") > -1) && (t.textTrack.some(function (e) {
                    ...
                    let l = "";
                    for (let s in t.textTrackStyle) l += s + ": " + t.textTrackStyle[s] + ";";
                    let u = t.id ? "#" + t.id : t.el.id ? "#" + t.el.id : "." + t.el.className;
                ...
                this.ev.forEach(function (e) {
                    ...
                    p.video.addEventListener(Object.keys(e)[0], function () {
                        p.logParams && ("play" === t ? p.hasStart = !0 : "waiting" === t ? (p.logParams.bc++, p.inWaitingStart = (new Date).getTime()) : "playing" === t ? p.inWaitingStart && (p.logParams.bu_acu_t += (new Date).getTime() - p.inWaitingStart, p.inWaitingStart = void 0) : "loadeddata" === t ? p.logParams.played.push({
                            ...
                            for (let e = [], t = 0, n = p.video.buffered.length; t < n; t++) e.push([p.video.buffered.start(t), p.video.buffered.end(t)]);
            ...
            return r(e, [{
                ...
                key: "getBufferedRange", value: function () {
                    let e = [0, 0], t = this.video, n = t.buffered, r = t.currentTime;
                    if (n) for (let a = 0, i = n.length; a < i && (e[0] = n.start(a), e[1] = n.end(a), !(e[0] <= r && r <= e[1])); a++) ;
                ...
                key: "error", get: function () {
                    ...
                    if (!e) return null;
                    let t = [{en: "MEDIA_ERR_ABORTED", cn: "取回过程被用户中止"}, {
                ...
                key: "networkState", get: function () {
                    let e = [{en: "NETWORK_EMPTY", cn: "音频/视频尚未初始化"}, {
                        en: "NETWORK_IDLE",
                ...
                key: "readyState", get: function () {
                    let e = [{en: "HAVE_NOTHING", cn: "没有关于音频/视频是否就绪的信息"}, {
                        en: "HAVE_METADATA",
                        cn: "关于音频/视频就绪的元数据"
        ...
        "use strict";
        let r, a, i, o, l, s, u, c = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
                return typeof e
            } : function (e) {
                return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
        ...
        "use strict";
        let r = n(12), a = n(20), i = n(21), o = n(22);
        ...
        "use strict";
        let r = n(15), a = n(19), i = Math.max;
        e.exports = function (e, t) {
            let n, o, l, s = i(arguments.length, 2);
        ...
        "use strict";
        let r = n(1), a = Array.prototype.forEach, i = Object.create;
        e.exports = function (e) {
            let t = i(null);
        ...
        "use strict";
        let r = String.prototype.indexOf;
        e.exports = function (e) {
        ...
        let a = function () {
            ...
            return r(e, [{
                key: "openDB", value: function (e) {
                    let t = this, n = this, r = this.myDB.version || 1, a = n.indexedDB.open(n.myDB.name, r);
                ...
                key: "addData", value: function (e, t) {
                    for (let n = this.myDB.db.transaction(e, "readwrite").objectStore(e), r = void 0, a = 0; a < t.length; a++) (r = n.add(t[a])).onerror = function () {
                    }, r.onsuccess = function () {
                    }
                }
            }, {
                key: "putData", value: function (e, t) {
                    for (let n = this.myDB.db.transaction(e, "readwrite").objectStore(e), r = void 0, a = 0; a < t.length; a++) (r = n.put(t[a])).onerror = function () {
                    }, r.onsuccess = function () {
                    }
                }
            }, {
                key: "getDataByKey", value: function (e, t, n) {
                    let r = this, a = this.myDB.db.transaction(e, "readwrite").objectStore(e).get(t);
                    a.onerror = function () {
                        n.call(r, null)
     ...
     */
        !function (i, o) {
            r = [n(28), n(29)], void 0 === (a = function (e, t) {
                return function (e, t, n) {
                    ...
                    let o = i.prototype = Object.create(n.prototype);
                    i.defaults = {}, o.option = function (e) {
                        r(this.options, e)
                    };
                    let l = {relative: !0, absolute: !0, fixed: !0};
                    ...
                    o._create = function () {
                        ...
                        let e = getComputedStyle(this.element), t = this._getPositionCoord(e.left, "width"),
                        ...
                        if (-1 != e.indexOf("%")) {
                            let r = t(this.element.parentNode);
                        ...
                        if (0 === t.indexOf("matrix")) {
                            let n = t.split(","), r = 0 === t.indexOf("matrix3d") ? 12 : 4, a = parseInt(n[r], 10),
                                i = parseInt(n[r + 1], 10);
                        ...
                        if (e) {
                            let n = t(this.element), r = t(e), a = this.element.getBoundingClientRect(),
                        ...
                        let e = this.options.containment;
                        ...
                        if (this.isEnabled) {
                            let r = n.x, a = n.y, i = this.options.grid, o = i && i[0], l = i && i[1];
                        ...
                        let r = "x" == e ? "width" : "height", a = s(-this.relativeStartPosition[e], n, "ceil"),
        ...
        "use strict";
        let r, a, i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
            return typeof e
        } : function (e) {
            return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
        };
        window, void 0 === (a = "function" == typeof(r = function () {
            function e(e) {
                let t = parseFloat(e), n = -1 == e.indexOf("%") && !isNaN(t);
                return n && t
            }

            let t = "undefined" == typeof console ? function () {
                } : function (e) {
                    console.error(e)
                },
            ...
            function s(t) {
                if (function () {
                    ...
                    for (let p = c.isBorderBox = "border-box" == u.boxSizing, d = 0; d < r; d++) {
                        let f = n[d], g = u[f], h = parseFloat(g);
                        c[f] = isNaN(h) ? 0 : h
                    }
                    let y = c.paddingLeft + c.paddingRight, x = c.paddingTop + c.paddingBottom,
        ...
        !function (i, o) {
            r = [n(30)], void 0 === (a = function (e) {
                return function (e, t) {
                    ...
                    let r = n.prototype = Object.create(t.prototype);
                    r.bindHandles = function () {
                        this._bindHandles(!0)
                    }, r.unbindHandles = function () {
                        this._bindHandles(!1)
                    }, r._bindHandles = function (t) {
                        for (let n = (t = void 0 === t || t) ? "addEventListener" : "removeEventListener", r = t ? this._touchActionValue : "", a = 0; a < this.handles.length; a++) {
                            let i = this.handles[a];
     ...
     */
            ...
            r = [n(31)], void 0 === (a = function (e) {
                return function (e, t) {
                    ...
                    r.bindStartEvent = function (e) {
                        ...
                        let r = (n = void 0 === n || n) ? "addEventListener" : "removeEventListener", a = "mousedown";
                    ...
                    return r._bindPostStartEvents = function (t) {
                        ...
                        let t = this.getTouch(e.changedTouches);
        ...
        "undefined" != typeof window && window, void 0 === (a = "function" == typeof(r = function () {
            ...
            return t.on = function (e, t) {
                if (e && t) {
                    let n = this._events = this._events || {}, r = n[e] = n[e] || [];
                ...
                if (n && n.length) {
                    n = n.slice(0), t = t || [];
                    for (let r = this._onceEvents && this._onceEvents[e], a = 0; a < n.length; a++) {
                        let i = n[a];
        ...
        a = [], void 0 === (i = "function" == typeof(r = function () {
            return function e(t, n, r) {
                let a, i, o = window, l = "application/octet-stream", s = r || l, u = t, c = !n && !r && u,
                ...
                if (/^data:([\w+-]+\/[\w+.-]+)?[,;]/.test(u)) {
                    ...
                    for (let y = 0, x = new Uint8Array(u.length), m = x.length; y < m; ++y) x[y] = u.charCodeAt(y);
                    u = new f([x], {type: s})
                }

                function v(e) {
                    for (let t = e.split(/[:;,]/), n = t[1], r = "base64" == t[2] ? atob : decodeURIComponent, a = r(t.pop()), i = a.length, o = 0, l = new Uint8Array(i); o < i; ++o) l[o] = a.charCodeAt(o);
        ...
        "use strict";
        let r, a = n(0), i = (r = a) && r.__esModule ? r : {default: r};
        i.default.install("volume", function () {
            let e = this, t = e.root, n = i.default.util, r = void 0, a = void 0, o = void 0, l = void 0;
            ...
            function u(t) {
                ...
                let r = o.getBoundingClientRect(), i = (t.clientX, t.clientY), s = l.getBoundingClientRect().height,
                    u = !1,
                    c = function (t) {
                        t.preventDefault(), t.stopPropagation(), n.event(t), u = !0;
                        let a = s - t.clientY + i, o = a / r.height;
                        ...
                        if (i.preventDefault(), i.stopPropagation(), n.event(i), window.removeEventListener("mousemove", c), window.removeEventListener("touchmove", c), window.removeEventListener("mouseup", t), window.removeEventListener("touchend", t), !u) {
                            let o = r.height - (i.clientY - r.top), s = o / r.height;
            ...
            function g() {
                f && clearTimeout(f), f = setTimeout(function () {
                    ...
                    let r = o.getBoundingClientRect().height || 76;
        ...
        i.default.install("start", function () {
            let e = this, t = e.root, n = i.default.util;
        ...
        ((r = a) && r.__esModule ? r : {default: r}).default.install("screenShot", function () {
            ...
            if (e.config.screenShot) {
                let t = document.createElement("canvas"), n = t.getContext("2d"), r = new Image;
            ...
            function i() {
                r.onload = function () {
                    ...
                    let i = r.src.replace(/^data:image\/[^;]+/, "data:application/octet-stream");
                    a(i, "截图.png")
                }()
            }
        })
        ...
        i.default.install("replay", function () {
            let e = this, t = i.default.util, n = e.root;
        ...
        ((r = a) && r.__esModule ? r : {default: r}).default.install("playNext", function () {
            let e = this, t = (e.root, e.config.playNext);
        ...
        i.default.install("pc", function () {
            let e = this, t = i.default.util, n = e.controls, r = e.root, a = 0, o = void 0;
            ...
            e.onElementClick = function (e, n) {
                ...
                if (e.preventDefault(), e.stopPropagation(), !this.config.closeVideoDblclick) {
                    let r = n.querySelector(".xgplayer-fullscreen");
                    if (r) {
                        let a = void 0;
        ...
        i.default.install("mobile", function () {
            let e = this, t = i.default.util, n = (e.controls, e.root);
        ...
        r.default.install("logger", function () {
            let e = this, t = r.default.util;
            if (!0 !== e.config.noLog) {
                let n = function () {
                    e.video.played;
                    let t = s(e.logParams.played), n = (new Date).getTime();
                    u();
                    let r = {
                ...
                let s = function () {
                    for (let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], t = [], n = 0; n < e.length; n++) if (!(!e[n].end || e[n].begin < 0 || e[n].end < 0 || e[n].end < e[n].begin)) if (t.length < 1) t.push({
                        begin: e[n].begin,
                        end: e[n].end
                    }); else for (let r = 0; r < t.length; r++) {
                        let a = e[n].begin, i = e[n].end;
                        if (i < t[r].begin) {
                            t.splice(r, 0, {begin: a, end: i});
                            break
                        }
                        if (!(a > t[r].end)) {
                            let o = t[r].begin, l = t[r].end;
                    ...
                    for (let s = 0, u = 0; u < t.length; u++) s += t[u].end - t[u].begin;
                    return s
                }, u = function () {
                    ...
                    if (t.hasClass(e.root, "xgplayer-is-enter")) {
                        ...
                        let i = s(e.logParams.played), o = (new Date).getTime();
                        u();
                        let l = {
                            url: e.logParams.pluginSrc ? e.logParams.pluginSrc : e.logParams.playSrc,
                            vid: e.config.vid,
        ...
        ((r = a) && r.__esModule ? r : {default: r}).default.install("localPreview", function () {
            ...
            function n(n) {
                ...
                let r = URL.createObjectURL(e.uploadFile);
        ...
        ((r = a) && r.__esModule ? r : {default: r}).default.install("i18n", function () {
            let e = this, t = {}, n = e.constructor.util;
            t.en = {
        ...
        i.default.install("fullscreen", function () {
            ...
            function a() {
                let r = document.fullscreenElement || document.webkitFullscreenElement || document.mozFullScreenElement || document.msFullscreenElement;
        ...
        i.default.install("danmu", function () {
            let e = this, t = (e.root, i.default.util);
            e.on("initDefaultDanmu", function (n) {
                let r = e.root.querySelector("xg-danmu");
        ...
        let a = {hmr: !0, transform: void 0, insertInto: void 0};
        n(56)(r, a);
                ...
                return this.map(function (t) {
                    let n = function (e, t) {
                        ...
                        if (t && "function" == typeof btoa) {
                            let a = (o = r, "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(o)))) + " */"),
        ...
        function d(e, t) {
            for (let n = 0; n < e.length; n++) {
                ...
                if (a) {
                    a.refs++;
                    for (let o = 0; o < a.parts.length; o++) a.parts[o](r.parts[o]);
        ...
        function f(e, t) {
            for (let n = [], r = {}, a = 0; a < e.length; a++) {
                let i = e[a], o = t.base ? i[0] + t.base : i[0], l = {css: i[1], media: i[2], sourceMap: i[3]};
        ...
        function g(e, t) {
            ...
            if ("top" === e.insertAt) r ? r.nextSibling ? n.insertBefore(t, r.nextSibling) : n.appendChild(t) : n.insertBefore(t, n.firstChild), c.push(t); else if ("bottom" === e.insertAt) n.appendChild(t); else {
                ...
                let a = l(e.insertInto + " " + e.insertAt.before);
                n.insertBefore(t, a)
            }
        }
        ...
        function m(e, t) {
            ...
            if (t.singleton) {
                ...
                let r = n.css, a = n.sourceMap, i = void 0 === t.convertToAbsoluteUrls && a;
                (t.convertToAbsoluteUrls || i) && (r = p(r));
                a && (r += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(a)))) + " */");
                let o = new Blob([r], {type: "text/css"}), l = e.href;
        ...
        e.exports = function (e, t) {
            ...
            return d(n, t), function (e) {
                ...
                for (a = 0; a < r.length; a++) {
                    let l;
                    if (0 === (l = r[a]).refs) {
                        for (let s = 0; s < l.parts.length; s++) l.parts[s]();
                        delete i[l.id]
                    }
                }
            }
        };
        let v, b = (v = [], function (e, t) {
        ...
        function k(e, t, n, r) {
            ...
            if (e.styleSheet) e.styleSheet.cssText = b(t, a); else {
                let i = document.createTextNode(a), o = e.childNodes;
        ...
        "use strict";
        e.exports = function (e) {
            let t = "undefined" != typeof window && window.location;
            if (!t) throw new Error("fixUrls requires window.location");
            if (!e || "string" != typeof e) return e;
            let n = t.protocol + "//" + t.host, r = n + t.pathname.replace(/\/[^\/]*$/, "/");
            return e.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function (e, t) {
                let a, i = t.trim().replace(/^"(.*)"$/, function (e, t) {
                    return t
        ...
        i.default.install("s_enter", function () {
            for (let e = this.root, t = i.default.util, n = "", r = 1; r <= 12; r++) n += '<div class="xgplayer-enter-bar' + r + '"></div>';
            let a = t.createDom("xg-enter", '<div class="xgplayer-enter-spinner">\n                                                  ' + n + "\n                                                </div>", {}, "xgplayer-enter");
            e.appendChild(a)
        })
    }, function (e, t, n) {
        "use strict";
        let r = o(n(0)), a = o(n(60)), i = o(n(61));
        ...
        r.default.install("s_play", function () {
            let e = this, t = r.default.util, n = e.config.playBtn ? e.config.playBtn : {}, o = void 0;
            ...
            let s = t.createDom("xg-tips", '<span class="xgplayer-tip-play">' + l.play + '</span>\n                                        <span class="xgplayer-tip-pause">' + l.pause + "</span>", {}, "xgplayer-tips");
        ...
        r.default.install("s_start", function () {
            let e = this, t = e.root, n = r.default.util,
        ...
        i.default.install("s_poster", function () {
            let e = this.root, t = i.default.util;
            if (this.config.poster) {
                let n = t.createDom("xg-poster", "", {}, "xgplayer-poster");
        ...
        i.default.install("s_flex", function () {
            this.root;
            let e = i.default.util.createDom("xg-placeholder", "", {}, "xgplayer-placeholder");
            this.controls.appendChild(e)
        })
    }, function (e, t, n) {
        "use strict";
        let r = o(n(0)), a = o(n(68)), i = o(n(69));
        ...
        r.default.install("s_fullscreen", function () {
            let e = this, t = r.default.util, n = e.config.fullscreenBtn ? e.config.fullscreenBtn : {}, o = void 0;
            ...
            let s = t.createDom("xg-tips", '<span class="xgplayer-tip-requestfull">' + l.requestfull + '</span>\n                                        <span class="xgplayer-tip-exitfull">' + l.exitfull + "</span>", {}, "xgplayer-tips");
            o.appendChild(s), e.once("ready", function () {
                e.controls.appendChild(o)
            }), ["click", "touchend"].forEach(function (t) {
                o.addEventListener(t, function (t) {
        ...
        "use strict";
        let r = l(n(0)), a = l(n(74)), i = l(n(75)), o = l(n(76));
        ...
        r.default.install("s_volume", function () {
            ...
            let n = t.querySelector(".xgplayer-slider"), l = t.querySelector(".xgplayer-bar"),
        ...
        i.default.install("s_definition", function () {
            let e = this, t = e.root, n = i.default.util, r = i.default.sniffer, a = void 0,
                o = n.createDom("xg-definition", "", {tabindex: 3}, "xgplayer-definition");

            function l() {
                let r = e.definitionList, a = ["<ul>"], i = e.config.url, l = document.createElement("a");
                ...
                let s = r.filter(function (t) {
                    return l.href = t.url, e.dash ? !0 === t.selected : l.href === i
                });
                a.push("</ul><p class='name'>" + (s[0] || {name: ""}).name + "</p>");
                let u = t.querySelector(".xgplayer-definition");
                if (u) {
                    u.innerHTML = a.join("");
                    let c = u.querySelector(".name");
            ...
            "mobile" === r.device && (e.config.definitionActive = "click"), e.on("resourceReady", s), ["touchend", "click"].forEach(function (t) {
                o.addEventListener(t, function (t) {
                    ...
                    let i = e.definitionList, l = t.target || t.srcElement, s = document.createElement("a");
        ...
        r.default.install("s_loading", function () {
            let e = this.root, t = r.default.util.createDom("xg-loading", "" + a.default, {}, "xgplayer-loading");
        ...
        i.default.install("s_progress", function () {
            let e = this, t = i.default.util,
                ...
                r = void 0;
            e.controls.appendChild(n);
            let a = n.querySelector(".xgplayer-progress-played"), o = n.querySelector(".xgplayer-progress-btn"),
            ...
            function d() {
                e.config.progressDot && "Array" === t.typeOf(e.config.progressDot) && e.config.progressDot.forEach(function (n) {
                    if (n.time >= 0 && n.time <= e.duration) {
                        let r = t.createDom("xg-progress-dot", n.text ? '<span class="xgplayer-progress-tip">' + n.text + "</span>" : "", {}, "xgplayer-progress-dot");
            ...
            e.dotArr = {}, e.once("canplay", d), e.addProgressDot = function (n, r) {
                if (!e.dotArr[n] && n >= 0 && n <= e.duration) {
                    let a = t.createDom("xg-progress-dot", "", {}, "xgplayer-progress-dot");
            ...
            e.config.thumbnail && (f = e.config.thumbnail.pic_num, g = e.config.thumbnail.width, h = e.config.thumbnail.height, y = e.config.thumbnail.col, x = e.config.thumbnail.row, v = e.config.thumbnail.urls, c.style.width = g + "px", c.style.height = h + "px"), ["touchstart", "mousedown"].forEach(function (i) {
                n.addEventListener(i, function (i) {
                    ...
                    let l = a.getBoundingClientRect().left, s = function (n) {
                        n.preventDefault(), n.stopPropagation(), t.event(n), e.isProgressMoving = !0;
                        let i = n.clientX - l > r ? r : n.clientX - l, s = i / r * e.duration;
                        if (a.style.width = 100 * i / r + "%", i - 7 < 0 ? (o.style.left = "0px", o.style.transform = "") : i + 7 > r ? (o.style.left = r - 14 + "px", o.style.transform = "") : (o.style.left = "100%", o.style.transform = "translate(-50%, 0)"), "video" !== e.videoConfig.mediaType || e.dash || e.config.closeMoveSeek) {
                            let u = t.findDom(e.controls, ".xgplayer-time");
                        ...
                        if (u.preventDefault(), u.stopPropagation(), t.event(u), window.removeEventListener("mousemove", s), window.removeEventListener("touchmove", s, {passive: !1}), window.removeEventListener("mouseup", i), window.removeEventListener("touchend", i), n.blur(), !e.isProgressMoving || "audio" === e.videoConfig.mediaType || e.dash || e.config.closeMoveSeek) {
                            let c = u.clientX - l, p = c / r * e.duration;
                ...
                let a = n.getBoundingClientRect().left, i = n.getBoundingClientRect().width, o = function (r) {
                    let o = (r.clientX - a) / i * e.duration;
                    o = o < 0 ? 0 : o, u.textContent = t.format(o);
                    let l = u.getBoundingClientRect().width;
                    if (e.config.thumbnail) {
                        m = e.duration / f;
                        let s = Math.floor(o / m);
                        c.style.backgroundImage = "url(" + v[Math.ceil((s + 1) / (y * x)) - 1] + ")";
                        let p = s + 1 - y * x * (Math.ceil((s + 1) / (y * x)) - 1), d = Math.ceil(p / x) - 1,
                            b = p - d * x - 1;
                        c.style["background-position"] = "-" + b * g + "px -" + d * h + "px";
                        let k = r.clientX - a - g / 2;
                        k = (k = k > 0 ? k : 0) < i - g ? k : i - g, c.style.left = k + "px", c.style.top = -10 - h + "px", c.style.display = "block", u.style.left = k + g / 2 - l / 2 + "px"
                    } else {
                        let w = r.clientX - a - l / 2;
            ...
            let b = !1, k = function () {
                if (!r && n && (r = n.getBoundingClientRect().width), "audio" !== e.videoConfig.mediaType || !e.isProgressMoving || !e.dash) {
                    ...
                    let t = e.currentTime / e.duration * r - 7;
            ...
            let w = function () {
                let t = e.buffered;
                if (t && t.length > 0) {
                    for (let n = t.end(t.length - 1), r = 0, a = t.length; r < a; r++) if (e.currentTime >= t.start(r) && e.currentTime <= t.end(r)) {
                        n = t.end(r);
                        for (let i = r + 1; i < t.length; i++) if (t.start(i) - t.end(i - 1) >= 2) {
                            n = t.end(i - 1);
                            break
                        }
                        break
        ...
        r.default.install("s_replay", function () {
            let e = this, t = r.default.util, n = e.root;
        ...
        i.default.install("s_playbackRate", function () {
            ...
            let n = t.createDom("xg-playbackrate", " ", {}, "xgplayer-playbackrate"), r = [];
            ...
            let l = e.root.querySelector(".xgplayer-playbackrate");
            if (l) {
        ...
        i.default.install("s_localPreview", function () {
            ...
            if (e.config.preview && e.config.preview.uploadEl) {
                let n = t.createDom("xg-preview", '<input type="file">', {}, "xgplayer-preview"),
        ...
        r.default.install("s_download", function () {
            ...
            if (e.config.download) {
                let n = t.createDom("xg-download", '<xg-icon class="xgplayer-icon">' + a.default + "</xg-icon>", {}, "xgplayer-download"),
        ...
        r.default.install("s_danmu", function () {
            let e = this, t = e.root, n = r.default.util;
            if (e.config.danmu) {
                let o = n.createDom("xg-danmu", "", {}, "xgplayer-danmu");
                e.once("ready", function () {
                    t.appendChild(o)
                });
                let l = n.deepCopy({
                ...
                e.config.danmu.panel && (s = r.default.util.createDom("xg-panel", '<xg-panel-icon class="xgplayer-panel-icon">\n                                                ' + i.default + '\n                                              </xg-panel-icon>\n                                              <xg-panel-slider class="xgplayer-panel-slider">\n                                                <xg-hidemode class="xgplayer-hidemode">\n                                                  <p class="xgplayer-hidemode-font">屏蔽类型</p>\n                                                  <ul class="xgplayer-hidemode-radio">\n                                                    <li class="xgplayer-hidemode-scroll" id="false">滚动</li><li class="xgplayer-hidemode-top" id="false">顶部</li><li class="xgplayer-hidemode-bottom" id="false">底部</li><li class="xgplayer-hidemode-color" id="false">色彩</li>\n                                                  </ul>\n                                                </xg-hidemode>\n                                                <xg-transparency class="xgplayer-transparency">\n                                                  <span>不透明度</span>\n                                                  <input class="xgplayer-transparency-line xgplayer-transparency-color xgplayer-transparency-bar xgplayer-transparency-gradient" type="range" min="0" max="100" step="0.1" value="50"></input>\n                                                </xg-transparency>\n                                                <xg-showarea class="xgplayer-showarea">\n                                                  <div class="xgplayer-showarea-name">显示区域</div>\n                                                  <div class="xgplayer-showarea-control">\n                                                    <div class="xgplayer-showarea-control-up">\n                                                      <span class="xgplayer-showarea-control-up-item xgplayer-showarea-onequarters">1/4</span>\n                                                      <span class="xgplayer-showarea-control-up-item xgplayer-showarea-twoquarters selected-color">1/2</span>\n                                                      <span class="xgplayer-showarea-control-up-item xgplayer-showarea-threequarters">3/4</span>\n                                                      <span class="xgplayer-showarea-control-up-item xgplayer-showarea-full">1</span>\n                                                    </div>\n                                                    <div class="xgplayer-showarea-control-down">\n                                                      <div class="xgplayer-showarea-control-down-dots">\n                                                        <span class="xgplayer-showarea-onequarters-dot"></span>\n                                                        <span class="xgplayer-showarea-twoquarters-dot"></span>\n                                                        <span class="xgplayer-showarea-threequarters-dot"></span>\n                                                        <span class="xgplayer-showarea-full-dot"></span>\n                                                      </div>\n                                                      <input class="xgplayer-showarea-line xgplayer-showarea-color xgplayer-showarea-bar xgplayer-gradient" type="range" min="1" max="4" step="1" value="1">\n                                                    </div>\n                                                  </div>\n                                                </xg-showarea>\n                                                <xg-danmuspeed class="xgplayer-danmuspeed">\n                                                  <div class="xgplayer-danmuspeed-name">弹幕速度</div>\n                                                  <div class="xgplayer-danmuspeed-control">\n                                                    <div class="xgplayer-danmuspeed-control-up">\n                                                      <span class="xgplayer-danmuspeed-control-up-item xgplayer-danmuspeed-small">慢</span>\n                                                      <span class="xgplayer-danmuspeed-control-up-item xgplayer-danmuspeed-middle selected-color">中</span>\n                                                      <span class="xgplayer-danmuspeed-control-up-item xgplayer-danmuspeed-large">快</span>\n                                                    </div>\n                                                    <div class="xgplayer-danmuspeed-control-down">\n                                                      <div class="xgplayer-danmuspeed-control-down-dots">\n                                                        <span class="xgplayer-danmuspeed-small-dot"></span>\n                                                        <span class="xgplayer-danmuspeed-middle-dot"></span>\n                                                        <span class="xgplayer-danmuspeed-large-dot"></span>\n                                                      </div>\n                                                      <input class="xgplayer-danmuspeed-line xgplayer-danmuspeed-color xgplayer-danmuspeed-bar xgplayer-gradient" type="range" min="50" max="150" step="50" value="100">\n                                                    </div>\n                                                  </div>\n                                                </xg-danmuspeed>\n                                                <xg-danmufont class="xgplayer-danmufont">\n                                                  <div class="xgplayer-danmufont-name">字体大小</div>\n                                                  <div class="xgplayer-danmufont-control">\n                                                    <div class="xgplayer-danmufont-control-up">\n                                                      <span class="xgplayer-danmufont-control-up-item xgplayer-danmufont-small">小</span>\n                                                      <span class="xgplayer-danmufont-control-up-item xgplayer-danmufont-middle">中</span>\n                                                      <span class="xgplayer-danmufont-control-up-item xgplayer-danmufont-large selected-color">大</span>\n                                                    </div>\n                                                    <div class="xgplayer-danmufont-control-down">\n                                                      <div class="xgplayer-danmufont-control-down-dots">\n                                                        <span class="xgplayer-danmufont-small-dot"></span>\n                                                        <span class="xgplayer-danmufont-middle-dot"></span>\n                                                        <span class="xgplayer-danmufont-large-dot"></span>\n                                                      </div>\n                                                      <input class="xgplayer-danmufont-line xgplayer-danmufont-color xgplayer-danmufont-bar xgplayer-gradient" type="range" min="20" max="30" step="5" value="25">\n                                                    </div>\n                                                  </div>\n                                                </xg-danmufont>\n                                              </xg-panel-slider>', {tabindex: 7}, "xgplayer-panel"), e.once("ready", function () {
                    ...
                    let t = new a.default(l);
                    if (e.emit("initDefaultDanmu", t), e.danmu = t, e.config.danmu.panel) {
                        let n = s.querySelector(".xgplayer-panel-slider"), i = void 0;
                        ...
                        for (let p in u) c(p);
                        let d = s.querySelector(".xgplayer-transparency-line"),
                        ...
                        }), navigator.userAgent.indexOf("Firefox") > -1) for (let h = 0; h < n.querySelectorAll("input").length; h++) n.querySelectorAll("input")[h].style.marginTop = "10px"
                    }
                })
            }
        })
        ...
        "use strict";
        (function (e) {
            let n, r, a, i, o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
                return typeof e
            } : function (e) {
                return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
            };
            window, i = function () {
                return function (e) {
                    ...
                    Object.defineProperty(t, "__esModule", {value: !0});
                    let r, a = (r = n(22)) && r.__esModule ? r : {default: r}, i = {};
                    ...
                    Object.defineProperty(t, "__esModule", {value: !0});
                    let r, a = (r = n(4)) && r.__esModule ? r : {default: r};
                    ...
                    let s = function () {
                        function e(t) {
                            ...
                            if (this.container = this.config.container, this.config.containerStyle) {
                                let r = this.config.containerStyle;
                        ...
                        return r(e, [{
                            ...
                            key: "setAllDuration", value: function () {
                                let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "scroll",
                            ...
                            key: "setDirection", value: function () {
                                let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "r2l";
                    ...
                    let r, a, i, l, s, u, c, p = n(6), d = n(20), f = Function.prototype.apply,
                    ...
                    let r = n(7), a = n(15), i = n(16), o = n(17);
                    (e.exports = function (e, t) {
                        let n, i, l, s, u;
                        return arguments.length < 2 || "string" != typeof e ? (s = t, t = e, e = null) : s = arguments[2], null == e ? (n = l = !0, i = !1) : (n = o.call(e, "c"), i = o.call(e, "e"), l = o.call(e, "w")), u = {
                            value: t,
                    ...
                    let s = function () {
                        ...
                        return r(e, [{
                            ...
                            key: "play", value: function () {
                                this.status = "playing";
                                let e = this.channel.channels, t = this.danmu.container.getBoundingClientRect();
                                e && e.length > 0 && ["scroll", "top", "bottom"].forEach(function (n) {
                                    for (let r = 0; r < e.length; r++) e[r].queue[n].forEach(function (e) {
                                        e.resized || (e.startMove(t), e.resized = !0)
                                    });
                                    for (let a = 0; a < e.length; a++) e[a].queue[n].forEach(function (e) {
                                        e.resized = !1
                                    })
                                })
                            }
                            ...
                            key: "readData", value: function () {
                                let e = this, t = this.danmu, n = 0;
                                t.player && t.player.currentTime && (n = o.default.formatTime(t.player.currentTime));
                                let r = void 0, a = e.interval, l = e.channel, s = void 0;
                        ...
                        return r(e, [{
                            key: "resize", value: function () {
                                ...
                                setTimeout(function () {
                                    ...
                                    let a, i = /mobile/gi.test(navigator.userAgent) ? 10 : 12;
                                    a = "b2t" === n.direction ? Math.floor(n.width / i) : Math.floor(n.height / i);
                                    for (let o = [], l = 0; l < a; l++) o[l] = {
                                        id: l,
                            ...
                            key: "addBullet", value: function (e) {
                                let t = this.danmu, n = this.channels, r = void 0, a = void 0, i = void 0;
                                ...
                                for (let o = !0, l = void 0, s = -1, u = 0, c = n.length; u < c; u++) if (n[u].queue[e.mode].some(function (t) {
                                    return t.id === e.id
                                })) return {result: !1, message: "exsited, channelOrder=" + u + ",danmu_id=" + e.id};
                                if ("scroll" === e.mode) for (let p = 0, d = n.length - i; p <= d; p++) {
                                    o = !0;
                                    for (let f = p; f < p + i; f++) {
                                        ...
                                        let g = l.queue.scroll[0];
                                        if (g) {
                                            let h = g.el.getBoundingClientRect();
                                            ...
                                            let y, x = void 0, m = void 0, v = void 0, b = void 0;
                                ...
                                } else if ("top" === e.mode) for (let k = 0, w = n.length - i; k <= w; k++) {
                                    o = !0;
                                    for (let _ = k; _ < k + i; _++) {
                                ...
                                } else if ("bottom" === e.mode) for (let E = n.length - i; E >= 0; E--) {
                                    o = !0;
                                    for (let C = E; C < E + i; C++) {
                                ...
                                if (-1 !== s) {
                                    for (let S = s, P = s + i; S < P; S++) (l = n[S]).operating[e.mode] = !0, l.queue[e.mode].unshift(e), e.prior && delete l.bookId[e.mode], l.operating[e.mode] = !1;
                                ...
                                if (e.prior) if (e.bookChannelId) t.bulletBtn.main.data.some(function (t) {
                                    ...
                                    s = -1;
                                    for (let T = 0, O = n.length - i; T <= O; T++) {
                                        o = !0;
                                        for (let L = T; L < T + i; L++) if (n[L].bookId[e.mode]) {
                                            o = !1;
                                            break
                                        }
                                        if (o) {
                                    ...
                                    if (-1 !== s) {
                                        for (let D = s; D < s + i; D++) n[D].bookId[e.mode] = e.id;
                            ...
                            key: "removeBullet", value: function (e) {
                                for (let t = this.channels, n = e.channel_id, r = void 0, a = n[0], i = n[0] + n[1]; a < i; a++) if (r = t[a]) {
                            ...
                            key: "resetArea", value: function () {
                                let e = this.danmu.container, t = this, n = e.getBoundingClientRect();
                                ...
                                let r, a = /mobile/gi.test(navigator.userAgent) ? 10 : 12;
                                r = "b2t" === t.direction ? Math.floor(t.width / a) : Math.floor(t.height / a);
                                for (let i = [], o = 0; o < r; o++) i[o] = {
                                    id: o,
                                    queue: {scroll: [], top: [], bottom: []},
                                    operating: {scroll: !1, top: !1, bottom: !1},
                                    bookId: {}
                            ...
                            key: "reset", value: function () {
                                let e = this.danmu.container, t = this;
                                t.channels && t.channels.length > 0 && ["scroll", "top", "bottom"].forEach(function (e) {
                                    for (let n = 0; n < t.channels.length; n++) t.channels[n].queue[e].forEach(function (e) {
                            ...
                            key: "resetWithCb", value: function (e, t) {
                                let n = this.danmu.container, r = this;
                                r.channels && r.channels.length > 0 && ["scroll", "top", "bottom"].forEach(function (e) {
                                    for (let t = 0; t < r.channels.length; t++) r.channels[t].queue[e].forEach(function (e) {
                                ...
                                let i, o = /mobile/gi.test(navigator.userAgent) ? 10 : 12;
                                i = "b2t" === r.direction ? Math.floor(r.width / o) : Math.floor(r.height / o);
                                for (let l = [], s = 0; s < i; s++) l[s] = {
                                    id: s,
                                    queue: {scroll: [], top: [], bottom: []},
                                    operating: {scroll: !1, top: !1, bottom: !1},
                                    bookId: {}
                        ...
                        return a(e, [{
                            ...
                            key: "pauseMove", value: function (e) {
                                ...
                                if ("paused" !== this.status && (this.status = "paused", clearTimeout(this.removeTimer), this.el)) if (this.el.style.willChange = "auto", "scroll" === this.mode) {
                                    if (t) {
                                        let n, r = ((new Date).getTime() - this.moveTime) / 1e3 * this.moveV;
                            ...
                            key: "startMove", value: function (e) {
                                ...
                                if (this.el && "start" !== this.status) if (this.status = "start", this.el.style.willChange = "transform", "scroll" === this.mode) if ("b2t" === this.direction) {
                                    ...
                                    let n = (t.el.getBoundingClientRect().bottom - e.top) / this.moveV;
                                    ...
                                    let r = (t.el.getBoundingClientRect().right - e.left) / this.moveV;
                                    ...
                                    let a = this.duration >= this.pastDuration ? this.duration - this.pastDuration : 0;
                                    this.removeTimer = setTimeout(i, a), this.startTime = (new Date).getTime()
                                }

                                function i() {
                                    if (t.el) if ("scroll" === t.mode) {
                                        let e = t.danmu.container.getBoundingClientRect(),
                        ...
                        return t.toString = function () {
                            return this.map(function (t) {
                                let n = function (e, t) {
                                    ...
                                    if (!a) return r;
                                    if (t && "function" == typeof btoa) {
                                        let i = (n = a, "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(n)))) + " */"),
                    ...
                    function g(e, t) {
                        for (let n = [], r = {}, a = 0; a < e.length; a++) {
                            let i = e[a], o = t.base ? i[0] + t.base : i[0],
                    ...
                    function h(e, t) {
                        ...
                        if ("top" === e.insertAt) r ? r.nextSibling ? n.insertBefore(t, r.nextSibling) : n.appendChild(t) : n.insertBefore(t, n.firstChild), p.push(t); else if ("bottom" === e.insertAt) n.appendChild(t); else {
                            ...
                            let a = s(e.insertInto + " " + e.insertAt.before);
                            n.insertBefore(t, a)
                        }
                    }
        ...
        r.default.install("s_playNext", function () {
            let e = this, t = r.default.util, n = e.config.playNext;
            if (n && n.urlList) {
                let i = t.createDom("xg-playnext", '<xg-icon class="xgplayer-icon">' + a.default + "</xg-icon>", {}, "xgplayer-playnext"),
        ...
        r.default.install("s_rotate", function () {
            let e = this, t = r.default.util;
            if (e.config.rotate) {
                let n = t.createDom("xg-rotate", '<xg-icon class="xgplayer-icon">' + a.default + "</xg-icon>", {}, "xgplayer-rotate"),
        ...
        i.default.install("s_textTrack", function () {
            if (!(navigator.userAgent.indexOf("Chrome") < 0)) {
                ...
                a && Array.isArray(a) && a.length > 1 && (n.addClass(e.root, "xgplayer-is-texttrack"), e.on("canplay", function () {
                    ...
                    let o = e.lang.TEXTTRACK;
                    i.push('</ul><p class="name"><em>' + o + "</em></p>");
                    let l = t.querySelector(".xgplayer-texttrack");
                    if (l) {
                        l.innerHTML = i.join("");
                        let s = l.querySelector(".name");
                    ...
                    r.addEventListener(t, function (t) {
                        ...
                        if (i && "li" === i.tagName.toLocaleLowerCase()) {
                            ...
                            let o = e.root.getElementsByTagName("Track");
        ...
        i.default.install("s_error", function () {
            ...
            t.appendChild(r);
            let a = r.querySelector(".xgplayer-error-text"), o = null;
