...
!function (e) {
    ...
    105: function (e, t) {
            ...
            return t = i, (n = [{
                ...
                key: "render", value: function (e, t) {
                    ...
                    return x.length || x.push(S("div", {class: "xm-select-empty"}, r)), S("div", {
                        ...
                        style: {width: u.indent + "px", maxHeight: e.height, overflowY: "auto"}
                    }, x)
                }
            }, {
                key: "componentDidMount", value: function () {
            ...
            return t = i, (n = [{
                ...
                key: "exchangeValue", value: function (e) {
                    ...
                    if (i.show && i.strict || a.show && a.strict) {
                        var f = function e(t, n) {
                            var o = n[l];
                            o && u(o) && o.forEach((function (n) {
                                -1 === c.findIndex((function (e) {
                                    return e[s] === n[s]
                                })) && t.push(n), e(t, n)
                            }))
                        }, d = {};
                        d[l] = c, f(p, d), p = p.filter((function (e) {
                ...
                key: "value", value: function (e, t, n, o) {
                    ...
                    if (!this.checkMax(s, s)) {
                        if (a.show && a.strict || l.show && l.strict) {
                            ...
                            this.clearAndReset(c, s, !1), s = this.init({data: c, prop: i}, !0)
                        }
                ...
                key: "clearAndReset", value: function (e, t, n) {
                    ...
                    e.forEach((function (e) {
                        ...
                        if (r && u(r)) {
                            ...
                            var c = r.length, p = r.filter((function (e) {
                                return !0 === e[i] || !0 === e.__node.selected
                            })).length;
                            e.__node.selected = p === c, e.__node.half = p > 0 && p < c || r.filter((function (e) {
                ...
                key: "load", value: function (e, t, n, o) {
                    ...
                    e.forEach((function (e) {
                        ...
                        if (l && u(l)) {
                            var s = l.length;
                            if (s > 0) {
                                r.load(l, t, n, e, i + 1, a), e[d] = !0, (c.show && c.strict || p.show && p.strict) && (!0 === e[m] && (delete e[m], l.forEach((function (e) {
                                    return e[m] = !0
                ...
                key: "itemClick", value: function (e, t, n, o) {
                    var r = this.props, i = (r.theme, r.prop), a = r.radio, l = r.repeat, s = r.clickClose,
                        c = (r.max, r.maxMethod, r.tree), u = r.data, p = ze(this.state.sels), f = i.value,
                        d = (i.selected, i.disabled, i.children), h = i.optgroup;
                    if (!n) {
                        if (e[h] && c.strict) {
                            e[d];
                            var m, b = [], y = !0;
                            ...
                            p = ze(this.state.sels), b = [], this.treeHandler(p, e, b, m, !0), this.resetSelectValue(p, b, y), this.setState({data: this.state.data})
                        } else if (!t || l && !o) {
                            if (this.checkMax(e, p)) return;
                            p = a ? [e] : [].concat(ze(p), [e]), this.clearAndReset(u, p, t), this.resetSelectValue(p, [e], !t)
                        } else {
                        ...
                        if (v) {
                            for (; v;) {
                                var g = v[d], _ = g.length, w = g.filter((function (e) {
                                    return -1 !== p.findIndex((function (t) {
                                        return t[f] === e[f]
                                    })) || !0 === e.__node.selected
                                })).length;
                                v.__node.selected = w === _, v.__node.half = w > 0 && w < _ || g.filter((function (e) {
                                    return !0 === e.__node.half
                                })).length > 0, v = v.__node.parent
                            }
        ...
        var ot = function () {
            ...
            return t = e, (n = [{
                ...
                key: "update", value: function () {
                    ...
                    this.options = f(this.options, e), this.options.__render_success = !1;
                ...
                key: "calcPosition", value: function () {
                    return st[this.options.el].calcPosition(), this
                }
        ...
        var at = {}, lt = {}, st = {};
        t.c = {
            name: o.a, version: o.b, doc: o.c, render: function (e) {
                var t = e.el;
                ...
                lt[t] = e;
                var r = new ot(e);
                return r && r.options.__render_success && (at[t] = r), r
            }, get: function (e, t) {
                var n;
