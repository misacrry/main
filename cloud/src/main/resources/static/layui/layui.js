...
!function (d) {
    ...
    Array.prototype.indexOf = Array.prototype.indexOf || function (n, i) {
        ...
        t = t || {};
        var e = p.elem("style"), n = t.text || "", i = t.target;
        ...
        var t = p(t), n = e.attr || "lay-options", t = t.attr(n);
        try {
        ...
        c && p.touchEventsSupported() && (n = {
            ...
            1 === t.touches.length && (c.addEventListener("touchmove", i, !!p.passiveSupported && {passive: !1}), c.addEventListener("touchend", r), c.addEventListener("touchcancel", r), n.timeStart = Date.now(), n.pointerStart.x = n.pointerEnd.x = t.touches[0].clientX, n.pointerStart.y = n.pointerEnd.y = t.touches[0].clientY, n.distanceX = n.distanceY = 0, n.direction = "none", o.onTouchStart) && o.onTouchStart(t, n)
        }, i = function (t) {
            ...
            o.onTouchEnd && o.onTouchEnd(t, n), c.removeEventListener("touchmove", i), c.removeEventListener("touchend", r, !!p.passiveSupported && {passive: !1}), c.removeEventListener("touchcancel", r)
        ...
        var e, n, i, c, a = (t = t || {}).event || ("onpointerdown" in d ? "pointerdown" : "mousedown"),
            u = t.scope || h, s = t.ignore || [], t = !("capture" in t) || t.capture;
        return e = u, n = a, i = function (t) {
            var e = r, n = t.target || t.srcElement, i = function (t) {
                var e = t.composedPath && t.composedPath() || t.path, t = t.target || t.srcElement;
            ...
            e && e !== n && -1 === i.indexOf(e) && !function (t, e) {
                for (var n = t.target || t.srcElement, i = 0; i < s.length; i++) {
                    var r = s[i];
                    if ("string" == typeof r) for (var o = h.querySelectorAll(r), c = 0; c < o.length; c++) {
                        var a = o[i];
            ...
            passive: !0,
            capture: t
        } : t, e.addEventListener ? e.addEventListener(n, i, c) : e.attachEvent("on" + n, i), function () {
...
!function (i, D) {
    ...
    var n = i.layui && layui.define, l = {
        ...
        }, e = i.LAYUI_GLOBAL || {}, a = "laydate", d = "lay-" + a + "-id", T = {
            v: "5.6.0",
            config: {weekStart: 0},
            ...
            ready: function (e) {
                var t = "laydate", a = (n ? "modules/" : "") + "laydate.css?v=" + T.v;
        ...
        }, M = "layui-this", C = "laydate-disabled", h = [100, 2e5], v = "layui-laydate-static", b = "layui-laydate-list",
        o = "laydate-selected", r = "layui-laydate-hint", y = "laydate-day-prev", m = "laydate-day-next",
        E = ".laydate-btns-confirm", L = "laydate-time-text", I = "laydate-btns-time", x = "layui-laydate-preview",
        w = "layui-laydate-shade", k = function (e) {
            var t, a = this,
    ...
    s.formatArr = function (e) {
        ...
        var a, n, i, l, r = this, o = r.config, d = r.lang(), s = "static" === o.position,
            ...
            p = (o.zIndex && (y.style.zIndex = o.zIndex), lay.each(new Array(2), function (e) {
                ...
                }), i.insertBefore(l, i.children[0]), n.appendChild(i), m[e] = lay.elem("div", {"class": "layui-laydate-main laydate-main-list-" + e}), m[e].appendChild(a), m[e].appendChild(n), u.push(t), c.push(n), h.push(i)
                ...
                y.appendChild(t)
            }), o.showBottom && y.appendChild(e), lay.elem("style")), f = [], g = !0,
        ...
        y.insertAdjacentHTML("beforebegin", t), r.checkDate().calendar(null, 0, "init"), r.changeEvent(), k.thisElemDate = r.elemID, r.renderAdditional(), "function" == typeof o.ready && o.ready(lay.extend({}, o.dateTime, {month: o.dateTime.month + 1})), r.preview()
        ...
        var n = this, e = n.config, i = function (e) {
            n.markRender(t, a, e)
        };
        ...
        var d = ["holidays", "workdays"], s = function (e, t, a) {
        ...
        t = t || {};
        var a = this.config, n = !a.range || 0 === t.rangeType ? "start" : "end";
        ...
        i = i ? 1 : 0;
        var l, r, o, d = this, a = d.config, s = e || d.thisDateTime(i), n = new Date, y = d.lang(),
            m = "date" !== a.type && "datetime" !== a.type, u = lay(d.table[i]).find("td"),
        ...
        var l, r, e, a, o, d, t, s = this, y = s.config, m = s.rangeLinked ? y.dateTime : [y.dateTime, s.endDate][i],
            u = s.lang(), c = y.range && "date" !== y.type && "datetime" !== y.type, h = lay.elem("ul", {
                "class": b + " " + {
                    year: "laydate-year-list",
                    month: "laydate-month-list",
                    time: "laydate-time-list"
                }[n]
            }), p = s.elemHeader[i], f = lay(p[2]).find("span"), g = s.elemCont[i || 0], D = lay(g).find("." + b)[0],
            T = "cn" === y.lang, v = T ? "\u5e74" : "", x = s.listYM[i] || {}, w = ["hours", "minutes", "seconds"],
        ...
        return x[0] < 1 && (x[0] = 1), "year" === n ? (e = l = x[0] - 7, l < 1 && (e = l = 1), lay.each(new Array(15), function (e) {
            ...
            l == x[0] && lay(t).addClass(M), t.innerHTML = l + v, h.appendChild(t), s.limit({
                ...
                rangeType: i,
                disabledType: "date"
            }), s.cellRender(t, {year: l, month: 1, date: 1}, "year"), l++
        }), lay(f[T ? 0 : 1]).attr("lay-ym", l - 8 + "-" + x[1]).html(e + v + " - " + (l - 1) + v)) : "month" === n ? (lay.each(new Array(12), function (e) {
            var t = lay.elem("li", {"lay-ym": e}), a = {year: x[0], month: e, date: 1};
            ...
            lay(h).find("ol").each(function (a, e) {
                lay(e).find("li").each(function (e, t) {
                    s.limit({
                        elem: lay(t),
                        date: [{hours: e}, {hours: s[k].hours, minutes: e}, {
                            hours: s[k].hours,
                            minutes: s[k].minutes,
                            seconds: e
                        }][a],
            ...
            var a = lay.elem("li"), n = ["<p>" + u.time[t] + "</p><ol>"];
        ...
        })) : (f = lay.elem("span", {"class": L}), d = function () {
        ...
        }), layui.device().mobile && D.css({overflowY: "auto", touchAction: "pan-y"})), s
        ...
        var a = this, n = Object.getOwnPropertyDescriptor(HTMLInputElement.prototype, "value");
        ...
        a.isPreview && (e = lay(t.elem).find("." + x), a = !a.range || (t.rangeLinked ? t.endState : t.endDate) ? t.parse() : "", e.html(a), e.html()) && (e.css({color: "#16b777"}), setTimeout(function () {
            e.css({color: "#777"})
        }, 300))
...
!function (p, m) {
    ...
    var h, g, e, n = p.layui && layui.define, f = {
            ...
            ready: function (e) {
                var t = "layer", i = (n ? "modules/" : "css/") + "layer.css?v=" + v.v;
            ...
            load: function (e, t) {
                return v.open(h.extend({type: 3, icon: e || 0, resize: !1, shade: .01, removeFocus: !1}, t))
            },
            tips: function (e, t, i) {
        ...
        l = "LAYUI_LAYER_CONTENT_RECORD_HEIGHT", i = (t.pt.config = {
            type: 0,
            shade: .3,
            fixed: !0,
            move: u[1],
            ...
            var e, t, i, n, a = this, o = a.config, s = a.index, r = "object" == typeof (d = o.content), l = h("body"),
                c = function (e) {
                    var t;
            ...
            if (o.id && h("." + u[0]).find("#" + o.id)[0]) e = h("#" + o.id).closest("." + u[0]), t = e.attr("times"), i = e.data("config"), n = h("#" + u.SHADE + t), "min" === (e.data("maxminStatus") || {}) ? v.restore(t) : i.hideOnClose && (n.show(), e.show(), c(e), setTimeout(function () {
                ...
                a.vessel(r, function (e, t, i) {
                    ...
                    a.resize()
                }, g.on("resize", f.events.resize[a.index])), o.time <= 0 || setTimeout(function () {
                    v.close(a.index)
            ...
            var n = this, a = n.config, e = h(document), o = n.layero, l = ["LAY_MOVE_DICT", "LAY_RESIZE_DICT"],
            ...
            t ? e.find(".layui-layer-btn-loading-icon")[0] || e.addClass("layui-layer-btn-is-loading").attr({disabled: ""}).prepend('<i class="layui-layer-btn-loading-icon layui-icon layui-icon-loading layui-anim layui-anim-rotate layui-anim-loop"></i>') : e.removeClass("layui-layer-btn-is-loading").removeAttr("disabled").find(".layui-layer-btn-loading-icon").remove()
        }, t.pt.callback = function () {
            var n = this, a = n.layero, o = n.config;
            ...
            var t = e.attr("type"), i = e.find(".layui-layer-content"), t = t === f.type[2] ? i.children("iframe") : i,
            ...
            var t, i, n;
            e && (t = v.getChildFrame("html", e).outerHeight(), i = (e = h("#" + u[0] + e)).find(u[1]).outerHeight() || 0, n = e.find("." + u[6]).outerHeight() || 0, e.css({height: t + i + n}), e.find("iframe").css({height: t}))
        }, v.iframeSrc = function (e, t) {
            h("#" + u[0] + e).find("iframe").attr("src", t)
        }, v.style = function (e, t, i) {
            var e = h("#" + u[0] + e), n = e.find(".layui-layer-content"), a = e.attr("type"),
            ...
            var t = h("#" + u[0] + e), i = h("#" + u.SHADE + e), n = t.find(".layui-layer-content"),
                a = t.attr("area").split(","), o = t.attr("type"), s = t.data("config") || {}, r = n.data(l);
            t.removeData("maxminStatus"), v.style(e, {
                ...
                overflow: "visible"
            }, !0), t.find(".layui-layer-max").removeClass("layui-layer-maxmin"), t.find(".layui-layer-min").show(), "page" === o && t.find(u[4]).show(), s.scrollbar ? f.restScrollbar(e) : f.setScrollbar(e), r !== m && (n.removeData(l), (o === f.type[2] ? n.children("iframe") : n).css({height: r})), i.show()
        }, v.full = function (t) {
            var i = h("#" + u[0] + t), e = i.data("maxminStatus");
            "max" !== e && ("min" === e && v.restore(t), i.data("maxminStatus", "max"), f.record(i), u.html.attr("layer-full") || f.setScrollbar(t), setTimeout(function () {
            ...
            var e, t,
                l = (e = h("." + u[0]).children("#" + s).closest("." + u[0]))[0] ? (s = e.attr("times"), e) : h("#" + u[0] + s),
                c = l.attr("type"), i = l.data("config") || {}, d = i.id && i.hideOnClose;
            l[0] && (t = function () {
                var o = {
                ...
                v.ie && v.ie < 10 || !i.isOutAnim ? t[d ? "hide" : "remove"]() : (t.css({opacity: 0}), setTimeout(function () {
                    t[d ? "hide" : "remove"]()
    ...
    v.prompt = function (i, n) {
        ...
        if ((n = h.extend(!0, {toolbar: !0, footer: !0}, n)).photos) {
            var t = !("string" == typeof n.photos || n.photos instanceof h), i = t ? n.photos : {}, o = i.data || [],
                r = i.start || 0, l = n.success;
            if (s.imgIndex = 1 + (0 | r), n.img = n.img || "img", delete n.success, t) {
                if (0 === o.length) return v.msg("\u6ca1\u6709\u56fe\u7247")
            } else {
                var c = h(n.photos), d = function () {
            ...
            s.imgprev = function (e) {
                ...
                s.main.find(".layui-layer-photos-prev").on("click", function (e) {
                    ...
                    var i = Date.now() - t.timeStart, i = t.distanceX / i, n = g.width() / 3;
            ...
            }, s.loadi = v.load(1, {shade: !("shade" in n) && [.9, m, "unset"], scrollbar: !1});
            var t = o[r].src, f = function (e) {
                v.close(s.loadi);
                var t, i = o[r].alt || "";
        ...
        g = (h = e)(p);
        var e = navigator.userAgent.toLowerCase(), e = /android|iphone|ipod|ipad|ios/.test(e), n = h(p);
        e && h.each({Height: "height", Width: "width"}, function (e, t) {
            var i = "inner" + e;
            g[t] = function () {
...
layui.define(["jquery", "laytpl", "lay", "util"], function (e) {
    "use strict";
    var n, i, t, c = layui.$, m = layui.laytpl, p = layui.util, l = layui.hint(),
        o = layui.device().mobile ? "touchstart" : "mousedown", r = "dropdown", y = "layui_" + r + "_index",
        f = "lay-" + r + "-id", h = {
        ...
        }, v = "layui-dropdown", a = "layui-menu-item-up", d = "layui-menu-item-down", w = "layui-menu-body-title",
        s = "layui-menu-item-group", V = "layui-menu-item-parent", u = "layui-menu-item-checked",
        C = "layui-menu-item-checked2", x = "layui-menu-body-panel", b = "layui-menu-body-panel-left",
        k = "layui-dropdown-shade", T = "." + s + ">." + w, E = function (e) {
            var i = this;
    ...
    E.prototype.config = {
        ...
        }), n) : (c.extend(l, lay.options(a[0])), !e && a[0] && a.attr(f) ? (t = g.getThis(a.attr(f))) ? t.reload(l, i) : void 0 : (l.elem = c(l.elem), l.id = "id" in l ? l.id : a.attr("id") || n.index, a.attr(f, l.id), l.customName = c.extend({}, h.config.customName, l.customName), (l.show || "reloadData" === i && n.elemView && c("body").find(n.elemView.get(0)).length) && n.render(e, i), void n.events()))
    }, E.prototype.render = function (e, i) {
        var a = this, d = a.config, s = d.customName, t = c("body"), n = function () {
                ...
                return layui.each(e, function (e, i) {
                    var t, n = i[s.children] && 0 < i[s.children].length, l = ("isSpreadItem" in i ? i : d).isSpreadItem,
                    ...
                    }, n || o ? ' class="' + t[o] + '"' : i.disabled ? ' class="layui-disabled"' : "") + ">", (t = "href" in i ? '<a href="' + i.href + '" target="' + (i.target || "_self") + '">' + a + "</a>" : a, n ? '<div class="' + w + '">' + t + ("parent" === o ? '<i class="layui-icon layui-icon-right"></i>' : "group" === o && d.isAllowSpread ? '<i class="layui-icon layui-icon-' + (l ? "up" : "down") + '"></i>' : "") + "</div>" : '<div class="' + w + '">' + t + "</div>"), "</li>"].join(""))).data("item", i), n && (l = c('<div class="layui-panel layui-menu-body-panel"></div>'), t = c("<ul></ul>"), "parent" === o ? (l.append(u(t, i[s.children])), a.append(l)) : a.append(u(t, i[s.children]))), r.append(a))
                }), r
            },
            l = ['<div class="layui-dropdown layui-border-box layui-panel layui-anim layui-anim-downbit" ' + f + '="' + d.id + '">', "</div>"].join("");
        !(e = "contextmenu" !== d.trigger && !lay.isTopElem(d.elem[0]) ? e : !0) && d.elem.data(y + "_opened") || (a.elemView = c("." + v + "[" + f + '="' + d.id + '"]'), "reloadData" === i && a.elemView.length ? a.elemView.html(d.content || n()) : (a.elemView = c(l), a.elemView.append(d.content || n()), d.className && a.elemView.addClass(d.className), d.style && a.elemView.attr("style", d.style), h.thisId = d.id, a.remove(), t.append(a.elemView), d.elem.data(y + "_opened", !0), e = d.shade ? '<div class="' + k + '" style="z-index:' + (a.elemView.css("z-index") - 1) + "; background-color: " + (d.shade[1] || "#000") + "; opacity: " + (d.shade[0] || d.shade) + '"></div>' : "", a.elemView.before(e), "mouseenter" === d.trigger && a.elemView.on("mouseenter", function () {
            clearTimeout(g.timer)
        }).on("mouseleave", function () {
            a.delayRemove()
        })), a.position(), (g.prevElem = a.elemView).data("prevElem", d.elem), a.elemView.find(".layui-menu").on(o, function (e) {
            layui.stope(e)
        ...
        n && (i = n.attr(f), e = n.data("prevElem"), t = (i = g.getThis(i)).config.close, e && e.data(y + "_opened", !1), n.remove(), delete g.prevElem, "function" == typeof t) && t.call(i.config, e), lay("." + k).remove()
        ...
        i.prevElem = e.elem, i.prevElemCallback = function (e) {
            clearTimeout(g.timer), i.e = e, t ? g.timer = setTimeout(function () {
                i.render()
        ...
        var t = e.children("ul"), n = e.hasClass(a), l = function () {
            c(this).css({display: ""})
        };
        ...
        if (h.thisId) {
            ...
            if (e) return !(e.elemView && !e.elemView[0] || !c("." + v)[0]) && void ("contextmenu" === e.config.trigger ? e.remove() : e.position())
        }
    }), i.on(o, function (e) {
        var i, t;
        h.thisId && (i = g.getThis(h.thisId)) && (t = i.config, !lay.isTopElem(t.elem[0]) && "contextmenu" !== t.trigger && (e.target === t.elem[0] || t.elem.find(e.target)[0] || i.elemView && e.target === i.elemView[0] || i.elemView && i.elemView.find(e.target)[0]) || i.remove())
    }), t = ".layui-menu:not(.layui-dropdown-menu) li", i.on("click", t, function (e) {
        var i = c(this), t = i.parents(".layui-menu").eq(0), n = i.hasClass(s) || i.hasClass(V),
            l = t.attr("lay-filter") || t.attr("id"), a = lay.options(this);
        i.hasClass("layui-menu-item-divider") || n || (t.find("." + u).removeClass(u), t.find("." + C).removeClass(C), i.addClass(u), i.parents("." + V).addClass(C), a.title = a.title || c.trim(i.children("." + w).text()), layui.event.call(this, r, "click(" + l + ")", a))
    ...
    }), t = ".layui-menu ." + V, i.on("mouseenter", t, function (e) {
        var i, t = c(this).find("." + x);
        t[0] && ((i = t[0].getBoundingClientRect()).right > n.width() && (t.addClass(b), (i = t[0].getBoundingClientRect()).left < 0) && t.removeClass(b), i.bottom > n.height()) && t.eq(0).css("margin-top", -(i.bottom - n.height() + 5))
...
layui.define(["jquery", "lay"], function (e) {
    ...
    var x = layui.$, b = layui.lay, m = {
        ...
        }, i = "slider", f = "layui-disabled", T = "layui-slider-bar", w = "layui-slider-wrap", M = "layui-slider-wrap-btn",
        L = "layui-slider-tips", E = "layui-slider-input-txt", Y = "layui-slider-hover", t = function (e) {
            var t = this;
    ...
    t.prototype.config = {
        ...
        var e = this.config, e = x.map([e.min, e.max, e.step], function (e, t) {
            e = String(e).split(".");
            return e[1] ? e[1].length : 0
        });
        return Math.max.apply(null, e)
    }, t.prototype.render = function () {
        var n = this, a = n.config, e = x(a.elem);
        ...
        var t, e = a.disabled ? "#c2c2c2" : a.theme,
            ...
            l = x(a.elem), s = l.next(".layui-slider");
        ...
        function p(e) {
            var t = "vertical" === a.type ? a.height : n.elemTemp[0].offsetWidth, i = n.elemTemp.find("." + w);
        ...
        var u = this, c = u.config, d = u.elemTemp, p = function () {
                return "vertical" === c.type ? c.height : d[0].offsetWidth
            }, v = d.find("." + w), o = d.next(".layui-slider-input"), r = o.children("." + E).children("input").val(),
            m = 100 / ((c.max - c.min) / c.step), f = u.precision(), h = function (e, t, i) {
                e = (e = 100 < (e = 100 < Math.ceil(e) * m ? Math.ceil(e) * m : Math.round(e) * m) ? 100 : e) < 0 ? 0 : e, v.eq(t).css("vertical" === c.type ? "bottom" : "left", e + "%");
                var n, a = y(v[0].offsetLeft), l = c.range ? y(v[1].offsetLeft) : 0,
                    ...
                    a = Math.abs(a - l), l = ("vertical" === c.type ? d.find("." + T).css({
                        height: a + "%",
                        bottom: s + "%"
                    }) : d.find("." + T).css({width: a + "%", left: s + "%"}), c.min + (c.max - c.min) * e / 100),
                ...
                var t = e / p() * 100 / m, i = Math.round(t) * m;
        ...
        d.find("." + M).each(function (o) {
            ...
            r.on("mousedown touchstart", function (e) {
                ...
                t = r, i = function (e) {
                    ...
                    n && n(b.touchEventsSupported() ? 1e3 : 0), g.remove(), c.done && c.done(u.value), b.touchEventsSupported() && (t[0].removeEventListener("touchmove", i, !!b.passiveSupported && {passive: !1}), t[0].removeEventListener("touchend", a), t[0].removeEventListener("touchcancel", a))
                }, x("#LAY-slider-moving")[0] || x("body").append(g), g.on("mousemove", i), g.on("mouseup", a).on("mouseleave", a), b.touchEventsSupported() && (t[0].addEventListener("touchmove", i, !!b.passiveSupported && {passive: !1}), t[0].addEventListener("touchend", a), t[0].addEventListener("touchcancel", a))
            })
...
layui.define(["jquery", "lay"], function (e) {
    "use strict";
    var x = layui.$, P = layui.lay, o = layui.hint(), i = layui.device().mobile ? "click" : "mousedown", r = {
        ...
        }, t = "colorpicker", l = "layui-colorpicker", c = ".layui-colorpicker-main", C = "layui-icon-down",
        w = "layui-icon-close", T = "layui-colorpicker-trigger-span", B = "layui-colorpicker-trigger-i",
        I = "layui-colorpicker-side-slider", E = "layui-colorpicker-basis", D = "layui-colorpicker-alpha-bgcolor",
        Y = "layui-colorpicker-alpha-slider", M = "layui-colorpicker-basis-cursor", X = "layui-colorpicker-main-input",
        j = function (e) {
            var i = {h: 0, s: 0, b: 0}, o = Math.min(e.r, e.g, e.b), t = Math.max(e.r, e.g, e.b), n = t - o;
            ...
            var e = F(e), o = [e.r.toString(16), e.g.toString(16), e.b.toString(16)];
        ...
        }, W = x(window), a = x(document), s = function (e) {
    ...
    s.prototype.config = {
        ...
        var i = this.config, e = x("#layui-colorpicker" + (e || this.index));
        ...
        var e, i = this, o = (i.config, i.elemColorBox.find("." + T)), t = i.elemPicker.find("." + X),
        ...
        var r = this, l = r.config, c = r.elemColorBox.find("." + T), a = c.attr("lay-type"),
            s = r.elemPicker.find(".layui-colorpicker-side"), o = r.elemPicker.find("." + I),
            d = r.elemPicker.find("." + E), t = r.elemPicker.find("." + M), u = r.elemPicker.find("." + D),
            f = r.elemPicker.find("." + Y), p = o[0].offsetTop / 180 * 360, h = 100 - (t[0].offsetTop + 3) / 180 * 100,
            g = (t[0].offsetLeft + 3) / 260 * 100, v = Math.round(f[0].offsetLeft / 280 * 100) / 100,
            m = r.elemColorBox.find("." + B), e = r.elemPicker.find(".layui-colorpicker-pre").children("div"),
            y = function (e, i, o, t) {
                r.select(e, i, o);
                var n = F({h: e, s: i, b: o}), e = H({h: e, s: i, b: o}), i = r.elemPicker.find("." + X).find("input");
        ...
        o.on("mousedown", function (e, i) {
            var t = this.offsetTop, n = (e.clientY === undefined ? i : e).clientY;
            k && layui.stope(e), b(function (e) {
                var i = t + (e.clientY - n), o = s[0].offsetHeight,
            ...
            var r = this.offsetTop, l = this.offsetLeft, c = (e.clientY === undefined ? i : e).clientY,
                a = (e.clientX === undefined ? i : e).clientX;
            k && layui.stope(e), b(function (e) {
                var i = r + (e.clientY - c), o = l + (e.clientX - a), t = d[0].offsetHeight, n = d[0].offsetWidth,
            ...
            var t = this.offsetLeft, n = (e.clientX === undefined ? i : e).clientX;
            k && layui.stope(e), b(function (e) {
                var i = t + (e.clientX - n), o = u[0].offsetWidth,
            ...
            x(this).on("click", function () {
                ...
                var e = this.style.backgroundColor, i = j(L(e)), o = e.slice(e.lastIndexOf(",") + 1, e.length - 1);
                p = i.h, g = i.s, h = i.b, 3 === (e.match(/[0-9]{1,3}/g) || []).length && (o = 1), v = o, y(i.h, i.s, i.b, o)
            })
        }), P.touchEventsSupported() && layui.each([{elem: s, eventType: "mousedown"}, {
            elem: u,
            eventType: "mousedown"
        ...
        this.config;
        var n = H({h: e, s: 100, b: 100}), e = (H({h: e, s: i, b: o}), e / 360 * 180), o = 180 - o / 100 * 180,
            i = i / 100 * 260, r = this.elemPicker.find("." + E)[0];
        ...
        var c = this, a = c.config, s = c.elemColorBox.find("." + T), d = c.elemPicker.find("." + X + " input"), o = {
            clear: function (e) {
                ...
                -1 < l.indexOf(",") ? (t = j(L(l)), c.select(t.h, t.s, t.b), s[0].style.background = o = "#" + H(t), 3 < (l.match(/[0-9]{1,3}/g) || []).length && "rgba" === s.attr("lay-type") && (n = 280 * l.slice(l.lastIndexOf(",") + 1, l.length - 1), c.elemPicker.find("." + Y).css("left", n), o = s[0].style.background = l)) : (3 === (n = -1 < (n = l).indexOf("#") ? n.substring(1) : n).length && (n = (r = n.split(""))[0] + r[0] + r[1] + r[1] + r[2] + r[2]), r = {
        ...
        c.elemPicker.on("click", "*[colorpicker-events]", function () {
            var e = x(this), i = e.attr("colorpicker-events");
            o[i] && o[i].call(this, e)
...
layui.define("jquery", function (t) {
    "use strict";
    var u = layui.$, d = (layui.hint(), layui.device()), r = "element", h = "layui-this", y = "layui-show",
        o = ".layui-tab-title", i = function () {
            ...
            return n[0] ? n.before(s) : l.append(s), e.append('<div class="layui-tab-item" ' + (i.id ? 'lay-id="' + i.id + '"' : "") + ">" + (i.content || "") + "</div>"), i.change && this.tabChange(t, i.id), l.data("LAY_TAB_CHANGE", i.change), w.tabAuto(i.change ? "change" : null), this
        }, i.prototype.tabDelete = function (t, i) {
            t = u(".layui-tab[lay-filter=" + t + "]").children(o).find('>li[lay-id="' + i + '"]');
            return w.tabDelete(null, t), this
        ...
        }, ".layui-nav"), p = "layui-nav-item", b = "layui-nav-bar", v = "layui-nav-tree", m = "layui-nav-child",
        g = "layui-nav-more", C = "layui-anim layui-anim-upbit", w = {
            tabClick: function (t) {
                var i = (t = t || {}).options || {}, a = t.liElem || u(this),
                    ...
                    n = "string" == typeof a.attr("lay-unselect"), s = e.attr("lay-filter"), o = a.attr("lay-id"),
                ...
                l || n || (a.addClass(h).siblings().removeClass(h), (o ? t = (t = i.filter('[lay-id="' + o + '"]')).length ? t : i.eq(c) : i.eq(c)).addClass(y).siblings().removeClass(y)), layui.event.call(this, r, "tab(" + s + ")", {
                    elem: e,
                    index: c,
                    id: o
                })
                ...
                !1 !== layui.event.call(i[0], r, "tabBeforeDelete(" + n + ")", {
                    ...
                    index: a,
                    id: s
                }) && (i.hasClass(h) && (i.next()[0] && i.next().is("li") ? w.tabClick.call(i.next()[0], {index: a + 1}) : i.prev()[0] && i.prev().is("li") && w.tabClick.call(i.prev()[0], null, a - 1)), i.remove(), (s ? i = (i = l.filter('[lay-id="' + s + '"]')).length ? i : l.eq(a) : l.eq(a)).remove(), setTimeout(function () {
                    w.tabAuto()
                }, 50), layui.event.call(this, r, "tabDelete(" + n + ")", {elem: e, index: a, id: s}))
            }, tabAuto: function (l, t) {
                var n = "layui-tab-more", s = "layui-tab-bar", o = "layui-tab-close", c = this;
                (t || u(".layui-tab")).each(function () {
                    var t = u(this), a = t.children(".layui-tab-title"),
                    ...
                    e && "false" !== e && a.find("li").each(function () {
                        var t, i = u(this);
                        i.find("." + o)[0] || "false" === i.attr("lay-allowclose") || ((t = u('<i class="layui-icon layui-icon-close layui-unselect ' + o + '"></i>')).on("click", w.tabDelete), i.append(t))
                ...
                var t = u(this), i = t.closest(f), a = i.attr("lay-filter"), e = t.parent(), l = t.siblings("." + m),
                    n = "string" == typeof e.attr("lay-unselect");
                if ("javascript:;" !== t.attr("href") && "_blank" === t.attr("target") || n || l[0] || (i.find("." + h).removeClass(h), e.addClass(h)), i.hasClass(v)) {
                    var n = p + "ed", s = !e.hasClass(n), o = function () {
                ...
                "string" == typeof e.attr("lay-accordion") && ((e = e.children(".layui-colla-item").children("." + y)).siblings(".layui-colla-title").children(".layui-colla-icon").html("&#xe602;"), e.removeClass(y)), a[n ? "addClass" : "removeClass"](y), i.html(n ? "&#xe61a;" : "&#xe602;"), layui.event.call(this, r, "collapse(" + l + ")", {
                    title: t,
                    content: a,
                    show: n
                })
            ...
            var a = "string" == typeof i && i ? '[lay-filter="' + i + '"]' : "", e = {
                tab: function (t) {
                    w.tabAuto.call({}, t)
                }, nav: function (t) {
                    var s = {}, o = {}, c = {}, r = "layui-nav-title";
                    (t || u(f + a)).each(function (t) {
                        var i = u(this), a = u('<span class="' + b + '"></span>'), e = i.find("." + p);
                        i.find("." + b)[0] || (i.append(a), (i.hasClass(v) ? e.find("dd,>." + r) : e).on("mouseenter", function () {
                            !function (t, i, a) {
                                ...
                                i.hasClass(v) ? n[0] || (e = l.children("." + r), t.css({
                                    ...
                                    opacity: 1
                                })) : (n.addClass(C), n.hasClass("layui-nav-child-c") && n.css({left: -(n.outerWidth() - l.width()) / 2}), n[0] ? t.css({
                                    ...
                                    n.addClass(y), l.find("." + g).addClass(g + "d")
                                }, 300))
                            }.call(this, a, i, t)
                        }).on("mouseleave", function () {
                            i.hasClass(v) ? a.css({
                                ...
                                i.find("." + m).removeClass(y), i.find("." + g).removeClass(g + "d")
                            }, 300))
                        }), i.on("mouseleave", function () {
                            clearTimeout(s[t]), c[t] = setTimeout(function () {
                                i.hasClass(v) || a.css({width: 0, left: a.position().left + a.width() / 2, opacity: 0})
                            }, 200)
...
layui.define(["lay", "layer"], function (e) {
    "use strict";
    var F = layui.$, a = layui.lay, t = layui.layer, R = layui.device(), i = "upload", s = "layui_" + i + "_index",
        w = {
        ...
        }, r = "layui-upload-file", l = "layui-upload-form", E = "layui-upload-iframe", L = "layui-upload-choose",
        T = "UPLOADING", D = function (e) {
            var t = this;
    ...
    D.prototype.config = {
        ...
        var t = this, i = t.config, n = F(i.elem);
        return 1 < n.length ? (layui.each(n, function () {
            w.render(F.extend({}, i, {elem: this}))
        }), t) : (F.extend(i, a.options(n[0], {attr: n.attr("lay-data") ? "lay-data" : null})), !e && n[0] && n.data(s) ? (e = o.getThis(n.data(s))) ? e.reload(i) : void 0 : (i.elem = F(i.elem), i.bindAction = F(i.bindAction), i.id = "id" in i ? i.id : n.attr("id") || t.index, t.file(), void t.events()))
        ...
        var i, n, a, o, r, u = this, f = u.config, s = f.text || {}, l = u.elemFile[0], c = function () {
            ...
            var a = 0, o = 0, r = c(), l = function () {
                ...
                var n = new FormData, t = function (e) {
            ...
            f.unified ? i({unified: !0, index: 0}) : layui.each(r, function (e, t) {
                i({index: e, file: t})
            })
        }, p = function () {
            var n = F("#" + E);
        ...
        }, v = f.exts, y = (n = [], layui.each(e || u.chooseFiles, function (e, t) {
            n.push(t.name)
        }), n), x = {
            preview: function (e) {
                u.preview(e)
        ...
        if (0 !== y.length) {
            ...
            if ("choose" !== t && !f.auto || (f.choose && f.choose(x), "choose" !== t)) {
                ...
                if (0 < f.size && !(R.ie && R.ie < 10)) if (layui.each(c(), function (e, t) {
        ...
        var a = this, n = a.config, o = function (e) {
        ...
        n.elem.off("upload.start").on("upload.start", function () {
            ...
            var i = F(this), t = f(t.originalEvent.dataTransfer.files);
...
layui.define(["lay", "layer", "util"], function (e) {
    "use strict";
    var T = layui.$, p = layui.layer, N = layui.util, l = layui.hint(), $ = (layui.device(), "form"), d = ".layui-form",
        A = "layui-this", j = "layui-hide", S = "layui-disabled", t = function () {
            this.config = {
                verify: {
                    required: function (e) {
            ...
            var u = this, i = u.config, a = T(d + (t ? '[lay-filter="' + t + '"]' : "")), n = {
                input: function (e) {
                    var e = e || a.find("input,textarea"),
                        t = (i.autocomplete && e.attr("autocomplete", i.autocomplete), function (e, t) {
                            ...
                            isNaN(a) || ("click" === t && (a = !!T(this).index() ? a - n : a + n), t = function (e) {
                                return ((e.toString().match(/\.(\d+$)/) || [])[1] || "").length
                            }, s = 0 <= s ? s : Math.max(t(n), t(i)), o || (c || r <= (a = a <= l ? l : a) && (a = r), 0 === s ? a = parseInt(a) : 0 < s && (a = a.toFixed(s)), e.val(a)), e[(a < l || r < a) && !o ? "addClass" : "removeClass"]("layui-input-number-out-of-range"), c) || ((n = {
                                increment: e.next().find(".layui-icon-up"),
                                decrement: e.next().find(".layui-icon-down")
                            }).increment[r <= a && !o ? "addClass" : "removeClass"](S), n.decrement[a <= l && !o ? "addClass" : "removeClass"](S))
                        });
                    a.find("input[lay-affix],textarea[lay-affix]").each(function () {
                        var r = T(this), s = r.attr("lay-affix"), o = "layui-input-wrap", c = "layui-input-suffix",
                            u = "layui-input-affix", e = r.is("[disabled]") || r.is("[readonly]"), d = function (e, t) {
                                ...
                                var a, t = T('<div class="' + u + '">'), e = layui.isArray(i.value) ? i.value : [i.value],
                                ...
                                l[0] ? ((n = l.find("." + u))[0] && n.remove(), l.prepend(t), r.css("padding-right", function () {
                                    ...
                                    T(this).hasClass(S) || ("function" == typeof i.click && i.click.call(this, r, i), layui.event.call(this, $, "input-affix(" + e + ")", {
                                        elem: r[0],
                                        affix: s,
                                        options: i
                                    }))
                    ...
                    var p = "\u8bf7\u9009\u62e9", C = "layui-form-select", w = "layui-select-none",
                        _ = "layui-select-create-option", f = "layui-select-panel-elem-data", e = e || a.find("select"),
                        y = function (n, e, t, i, u, a) {
                            var l, d, r, s, o, c, h, p, f, y = T(this), v = e, m = v.find("input"), g = n.find("dl"),
                                b = (g.children("dd"), g.children("dt")), k = this.selectedIndex, x = "";
                            t || (d = "cs" === y.attr("lay-search") ? {caseSensitive: !0} : lay.options(y, {attr: "lay-search"}), r = y.attr("lay-append-to") || "body", s = y.attr("lay-append-position"), o = !(!lay.ie || "10" !== lay.ie && "11" !== lay.ie || !m.attr("placeholder")), c = function () {
                                a && (n.appendTo(r).css({width: v.width() + "px"}), (e = function () {
                                    lay.position(v[0], n[0], {position: s, allowBottomOut: !0, offset: [0, 5]})
                                })(), T(window).on("resize.lay_select_resize", e));
                                var e = n.offset().top + n.outerHeight() + 5 - O.scrollTop(), t = g.outerHeight(),
                                    i = g.children("dd");
                                k = y[0].selectedIndex, v.parent().addClass(C + "ed"), i.removeClass(j), b.removeClass(j), i.removeClass(A), 0 <= k && i.eq(k).addClass(A), e + t > O.height() && t <= e && n.addClass(C + "up"), p(), o && g.off("mousedown.lay_select_ieph").on("mousedown.lay_select_ieph", function () {
                                ...
                                v.parent().removeClass(C + "ed " + C + "up"), m.blur(), u && g.children("." + _).remove(), l && l(), a && (n.detach(), T(window).off("resize.lay_select_resize")), e || f(m.val(), function (e) {
                                    var t = y[0].selectedIndex;
                                    e && (x = T(y[0].options[t]).html(), 0 === t && x === m.attr("placeholder") && (x = ""), m.val(x || ""))
                                })
                            }, p = function () {
                                ...
                                var e = n.keyCode, t = (9 === e && h(), function (e) {
                                    n.preventDefault();
                                    var t, i, a = g.children("dd:not(." + j + ",." + S + ")");
                                    a.length && (t = a.length - 1, i = -1, layui.each(a, function (e, t) {
                                        if (T(t).hasClass(A)) return i = e, !0
                                    }), e = "prev" === e ? i - 1 < 0 ? t : i - 1 : t < i + 1 ? 0 : i + 1, a.eq(e).addClass(A).siblings().removeClass(A), p())
                                });
                                38 === e && t("prev"), 40 === e && t("next"), 13 === e && (n.preventDefault(), g.children("dd." + A).trigger("click"))
                            }).on("paste", function () {
                                c()
                            }), f = function (n, e, l) {
                                var r, s = 0, t = g.children("dd"), o = !1, c = n,
                                    t = (d.caseSensitive || (n = n.toLowerCase()), d.fuzzy && (r = function (e, t) {
                                        ...
                                        var e = T(this), t = e.text(), i = u && e.hasClass(_),
                                            a = (u && !i && t === c && (o = !0), d.caseSensitive || (t = t.toLowerCase()), d.fuzzy ? !r.test(t) : -1 === t.indexOf(n));
                                        ("" === n || "blur" === l ? n !== t : a) && s++, "keyup" === l && e[(u ? a && !i : a) ? "addClass" : "removeClass"](j)
                                    }), "keyup" === l && layui.each(b, function () {
                                        var e = T(this), t = e.nextUntil("dt").filter("dd");
                                        e[(t = u ? t.not("." + _) : t).length == t.filter("." + j).length ? "addClass" : "removeClass"](j)
                                    }), s === t.length);
                                return e(t, o), t
                            }, i && m.on("input propertychange", layui.debounce(function (e) {
                                var n = this.value, t = e.keyCode;
                                return 9 !== t && 13 !== t && 37 !== t && 38 !== t && 39 !== t && 40 !== t && (o && e.target.__ieph ? e.target.__ieph = !1 : (f(n, function (e, t) {
                                    var i, a;
                                    u ? t ? g.children("." + _).remove() : (t = g.children("." + _))[0] ? t.attr("lay-value", n).html(N.escape(n)) : (t = T("<dd>").addClass(_).attr("lay-value", n).html(N.escape(n)), a = (i = g.children().eq(0)).hasClass("layui-select-tips"), i[a ? "after" : "before"](t)) : e ? g.find("." + w)[0] || g.append('<p class="' + w + '">\u65e0\u5339\u914d\u9879</p>') : g.find("." + w).remove()
                                }, "keyup"), "" === n && (y.val(""), g.find("." + A).removeClass(A), (y[0].options[0] || {}).value || g.children("dd:eq(0)").addClass(A), g.find("." + w).remove(), u) && g.children("." + _).remove(), void p()))
                            }, 50)).on("blur", function (e) {
                                var t = y[0].selectedIndex;
                                x = T(y[0].options[t]).text(), 0 === t && x === m.attr("placeholder") && (x = ""), setTimeout(function () {
                                    f(m.val(), function (e) {
                                        x || m.val("")
                                    }, "blur")
                                }, 200)
                                ...
                                return t.hasClass(S) || (t.hasClass("layui-select-tips") ? m.val("") : (m.val(t.text()), t.addClass(A)), u && t.hasClass(_) && (g.append(t.removeClass(_)), e = T("<option>").attr("value", i).text(t.text()), y.append(e)), t.siblings().removeClass(A), y.val(i).removeClass("layui-form-danger"), layui.event.call(this, $, "select(" + a + ")", {
                                    elem: y[0],
                                    value: i,
                                    othis: n
                                }), h(!0)), !1
                    ...
                    T.event.special["_lay-select-destroy"] = {
                        ...
                        var i = T(this), a = i.next("." + C), n = this.disabled, l = t.value,
                            r = T(t.options[t.selectedIndex]), t = t.options[0];
                        ...
                        var s, o, c = "string" == typeof i.attr("lay-search"),
                            ...
                            d = "string" == typeof i.attr("lay-append-to"), t = t && !t.value && t.innerHTML || p,
                            h = T(['<div class="' + (c ? "" : "layui-unselect ") + C, (n ? " layui-select-disabled" : "") + '"></div>'].join("")),
                            t = T(['<div class="layui-select-title">', '<input type="text" placeholder="' + N.escape(T.trim(t)) + '" value="' + N.escape(T.trim(l ? r.html() : "")) + '"' + (!n && c ? "" : " readonly") + ' class="layui-input' + (c ? "" : " layui-unselect") + (n ? " " + S : "") + '">', '<i class="layui-edge"></i>', "</div>"].join("")),
                            r = T(['<dl class="layui-anim layui-anim-upbit' + (i.find("optgroup")[0] ? " layui-select-group" : "") + '">', (r = i.find("*"), s = [], layui.each(r, function (e, t) {
                            ...
                            }), 0 === s.length && s.push('<dd lay-value="" class="' + S + '">\u6ca1\u6709\u9009\u9879</dd>'), s.join("") + "</dl>")].join(""));
                        a[0] && (d && (o = a.data(f)) && o.remove(), a.remove()), d ? (h.append(t), i.after(h), o = T('<div class="' + C + ' layui-select-panel-wrap"></div>').append(r), h.data(f, o), y.call(this, o, t, n, c, u, d)) : (h.append(t).append(r), i.after(h), y.call(this, h, t, n, c, u, d))
                    })
                }, checkbox: function (e) {
                    var c = {
                    ...
                    e.each(function (e, t) {
                        var i = T(this), a = i.attr("lay-skin") || "primary",
                            n = N.escape(T.trim(t.title || (t.title = i.attr("lay-text") || ""))), l = this.disabled,
                            r = c[a] || c.checkbox, s = i.next("." + r[0]), o = (s[0] && s.remove(), []);
                        ...
                        i.after(l), function (t, i) {
                            var a = T(this), e = a.attr("lay-skin") || "primary", n = "switch" === e, e = "primary" === e;
                            t.on("click", function () {
                                var e = a.attr("lay-filter");
                                a[0].disabled || (a[0].indeterminate && (a[0].indeterminate = !1), a[0].checked = !a[0].checked, layui.event.call(a[0], $, i[2] + "(" + e + ")", {
                                    elem: a[0],
                                    value: a[0].value,
                                    othis: t
                                }))
                    ...
                    var o = "layui-form-radio", c = ["layui-icon-radio", "layui-icon-circle"],
                        e = e || a.find("input[type=radio]");
                    e.each(function (e, t) {
                        var i = T(this), a = i.next("." + o), n = this.disabled, l = i.attr("lay-skin");
                        if ("string" == typeof i.attr("lay-ignore")) return i.show();
                        a[0] && a.remove();
                        var a = N.escape(t.title || ""), r = [],
                            ...
                            }), r = r.join(" "), T(['<div class="layui-unselect ' + o, t.checked ? " " + o + "ed" : "", (n ? " layui-radio-disabled " + S : "") + '"', l ? ' lay-skin="' + l + '"' : "", ">", '<i class="layui-anim layui-icon ' + c[t.checked ? 0 : 1] + '"></i>', "<div " + r + ">" + a + "</div>", "</div>"].join("")));
                        i.after(s), function (i) {
                            var a = T(this), n = "layui-anim-scaleSpring";
                            i.on("click", function () {
                                var e = a.attr("lay-filter");
                                a[0].disabled || (a[0].checked = !0, layui.event.call(a[0], $, "radio(" + e + ")", {
                                    elem: a[0],
                                    value: a[0].value,
                                    othis: i
                                }))
                                ...
                                var e, t = this;
                                t.checked ? (i.addClass(o + "ed"), i.children(".layui-icon").addClass(n + " " + c[0]), e = a.parents(d).find("input[name=" + t.name.replace(/(\.|#|\[|\])/g, "\\$1") + "]"), layui.each(e, function () {
            ...
            return "object" === layui.type(e) ? T(e).is(d) ? (a = T(e), t()) : e.each(function (e, t) {
                var i = T(t);
            ...
            return !(e = T(e))[0] || (e.attr("lay-verify") !== undefined || !1 !== this.validate(e.find("*[lay-verify]"))) && (layui.each(e, function (e, r) {
                var s = T(this), t = (s.attr("lay-verify") || "").split("|"), o = s.attr("lay-vertype"),
                    c = T.trim(s.val());
                if (s.removeClass(h), layui.each(t, function (e, t) {
                    ...
                    if (a) {
                        ...
                        if ("required" === t && (i = s.attr("lay-reqtext") || i), n) return "tips" === o ? p.tips(i, "string" != typeof s.attr("lay-ignore") && l ? s.next() : s, {tips: 1}) : "alert" === o ? p.alert(i, {
                            title: "\u63d0\u793a",
                            shadeClose: !0
                        }) : /\b(string|number)\b/.test(typeof i) && p.msg(i, {icon: 5, shift: 6}), setTimeout(function () {
            ...
            var i = {}, a = T(this), e = "string" == typeof e ? e : a.attr("lay-filter"),
                n = this.getFormElem ? this.getFormElem(e) : a.parents(d).eq(0), l = n.find("*[lay-verify]");
            return !!r.validate(l) && (i = r.getValue(null, n), l = {
                ...
                field: i
            }, "function" == typeof t && t(l), layui.event.call(this, $, "submit(" + e + ")", l))
        });
    var r = new t, t = T(document), O = T(window);
    T(function () {
        r.render()
    ...
    }), t.on("submit", d, i).on("click", "*[lay-submit]", i), e($, r)
});
layui.define(["lay", "laytpl", "laypage", "form", "util"], function (s) {
    "use strict";
    var p = layui.$, r = layui.lay, m = layui.laytpl, P = layui.laypage, f = layui.layer, i = layui.form,
        v = layui.util, g = layui.hint(), b = layui.device(), x = {
            config: {
        ...
        }, T = "table", N = "lay-" + T + "-id", t = ".layui-table", R = "layui-hide", y = "layui-hide-v", h = "layui-none",
        D = "layui-table-view", o = ".layui-table-header", E = ".layui-table-body", z = ".layui-table-fixed-r",
        O = ".layui-table-pageview", A = ".layui-table-sort", _ = "layui-table-checked", L = "layui-table-edit",
        M = "layui-table-hover", u = "laytable-cell-group", W = "layui-table-col-special", H = "layui-table-tool-panel",
        j = "layui-table-expanded", I = "layui-table-disabled-transition", S = "LAY_TABLE_MOVE_DICT", e = function (e) {
        ...
        d = p(window), F = p(document), n = function (e) {
            ...
            })[N] = a.id, l)).html(m(B, {open: "{{", close: "}}"}).render({
                data: a,
                index: t.index
            })), t.renderStyle(), i[0] && i.remove(), e.after(n), t.layTool = n.find(".layui-table-tool"), t.layBox = n.find(".layui-table-box"), t.layHeader = n.find(o), t.layMain = n.find(".layui-table-main"), t.layBody = n.find(E), t.layFixed = n.find(".layui-table-fixed"), t.layFixLeft = n.find(".layui-table-fixed-l"), t.layFixRight = n.find(z), t.layTotal = n.find(".layui-table-total"), t.layPage = n.find(".layui-table-page"), t.renderToolbar(), t.renderPagebar(), t.fullSize(), t.pullData(t.page), t.events()
            ...
            var l, o = this, e = o.config, d = e.elem.attr("lay-filter"),
                ...
                n = ("default" === e.toolbar ? a.html(t) : "string" == typeof e.toolbar && (t = p(e.toolbar).html() || "") && a.html(m(t).render(e)), {
                    filter: {
                        title: "\u7b5b\u9009\u5217",
                            ...
                            (0, e.openPanel)({
                                list: (a = [], o.eachCols(function (e, t) {
                                    ...
                                    i.on("checkbox(LAY_TABLE_TOOL_COLS)", function (e) {
                                        var e = p(e.elem), t = this.checked, a = e.data("key"), i = o.col(a), l = i.hide,
                                            e = e.data("parentkey");
                                        i.key && (i.hide = !t, o.elem.find('*[data-key="' + a + '"]')[t ? "removeClass" : "addClass"](R), l != i.hide && o.setParentCol(!t, e), o.resize(), layui.event.call(this, T, "colToggled(" + d + ")", {
                                            col: i,
                                            config: n
                                        }))
                                    })
                    ...
                    exports: {
                        ...
                        onClick: function (e) {
                            var t = e.data, a = e.config, i = e.openPanel, e = e.elem;
                            if (!t.length) return f.tips("\u5f53\u524d\u8868\u683c\u65e0\u6570\u636e", e, {tips: 3});
                            b.ie ? f.tips("\u5bfc\u51fa\u529f\u80fd\u4e0d\u652f\u6301 IE\uff0c\u8bf7\u7528 Chrome \u7b49\u9ad8\u7ea7\u6d4f\u89c8\u5668\u5bfc\u51fa", e, {tips: 3}) : i({
                    ...
                    print: {
                        title: "\u6253\u5370", layEvent: "LAYTABLE_PRINT", icon: "layui-icon-print", onClick: function (e) {
                            var t = e.data, e = (e.config, e.elem);
                            if (!t.length) return f.tips("\u5f53\u524d\u8868\u683c\u65e0\u6570\u636e", e, {tips: 3});
                            ...
                            a.append(o.layMain.find("table").html()), a.append(o.layTotal.find("table").html()), a.find("th.layui-table-patch").remove(), a.find("thead>tr>th." + W).filter(function (e, t) {
                                return !p(t).children("." + u).length
                            }).remove(), a.find("tbody>tr>td." + W).remove(), t.document.write(e + a.prop("outerHTML")), t.document.close(), layui.device("edg").edg ? (t.onafterprint = t.close, t.print()) : (t.print(), t.close())
                        }
                    }
                });
            "object" == typeof e.defaultToolbar && (l = [], e.defaultToolbar = p.map(e.defaultToolbar, function (e, t) {
                var a = "string" == typeof e, i = a ? n[e] : e;
                return i && (!(i = i.name && n[i.name] ? p.extend({}, n[i.name], i) : i).name && a && (i.name = e), l.push('<div class="layui-inline" title="' + i.title + '" lay-event="' + i.layEvent + '"><i class="layui-icon ' + i.icon + '"></i></div>')), i
            ...
            })), n.setGroupWidth(), n.layMain.find("tbody").is(":empty") ? (e = n.layHeader.first().children("table").width(), n.layMain.find("table").width(e)) : n.layMain.find("table").width("auto")
            ...
            a[0] && (t.layNone.remove(), a.remove()), t.layFixed.addClass(R), t.layMain.find("tbody").html(""), t.layMain.append(t.layNone = e), t.layTotal.addClass(y), t.layPage.find(O).addClass(y), x.cache[t.key] = [], t.syncCheckAll(), t.renderForm(), t.setColsWidth(), t.loading(!1)
        }, n.prototype.page = 1, n.prototype.pullData = function (a, t) {
            var e, i, l = this, n = l.config,
                ...
                r = function () {
                    ...
                    l.setColsWidth(), l.loading(!1), "function" == typeof n.done && n.done(e, a, e[d.countName], t)
                };
            t = t || {}, "function" == typeof n.before && n.before(n), l.startTime = (new Date).getTime(), t.renderData ? ((e = {})[d.dataName] = x.cache[l.key], e[d.countName] = n.url ? "object" === layui.type(n.page) ? n.page.count : e[d.dataName].length : n.data.length, "object" == typeof n.totalRow && (e[d.totalRowName] = p.extend({}, l.totalRow)), l.renderData({
                ...
                type: t.type,
                sort: !0
            }), c(e, "renderData")) : n.url ? (i = {}, n.page && (i[o.pageName] = a, i[o.limitName] = n.limit), o = p.extend(i, n.where), n.contentType && 0 == n.contentType.indexOf("application/json") && (o = JSON.stringify(o)), l.loading(!0), p.ajax({
                type: n.method || "get",
                url: n.url,
                ...
                success: function (e) {
                    (e = "function" == typeof n.parseData ? n.parseData(e) || e : e)[d.statusName] != d.statusCode ? l.errorView(e[d.msgName] || '\u8fd4\u56de\u7684\u6570\u636e\u4e0d\u7b26\u5408\u89c4\u8303\uff0c\u6b63\u786e\u7684\u6210\u529f\u72b6\u6001\u7801\u5e94\u4e3a\uff1a"' + d.statusName + '": ' + d.statusCode) : (l.totalRow = e[d.totalRowName], l.renderData({
                        ...
                        count: e[d.countName],
                        type: t.type
                    }), r(), n.time = (new Date).getTime() - l.startTime + " ms"), c(e, t.type)
                },
                error: function (e, t) {
            ...
            return n = n || 1, layui.each(a, function (e, o) {
                ...
                "array" === layui.type(o) && 0 === o.length || (o[x.config.numbersName] = c, l || (o[x.config.indexName] = e), s.eachCols(function (e, l) {
                    ...
                    n !== undefined && null !== n || (n = ""), l.colGroup || (e = ['<td data-field="' + e + '" data-key="' + a + '" ' + (e = [], (t = "function" == typeof l.edit ? l.edit(o) : l.edit) && e.push('data-edit="' + t + '"'), l.templet && e.push('data-content="' + v.escape(n) + '"'), l.toolbar && e.push('data-off="true"'), l.event && e.push('lay-event="' + l.event + '"'), l.minWidth && e.push('data-minwidth="' + l.minWidth + '"'), l.maxWidth && e.push('data-maxwidth="' + l.maxWidth + '"'), l.style && e.push('style="' + l.style + '"'), e.join(" ")) + ' class="' + (t = [], l.hide && t.push(R), l.field || t.push(W), t.join(" ")) + '">', '<div class="layui-table-cell laytable-cell-' + ("normal" === l.type ? a : a + " laytable-cell-" + l.type) + '"' + (l.align ? ' align="' + l.align + '"' : "") + ">" + function () {
                ...
                }), e = ['data-index="' + e + '"'], o[x.config.checkName] && e.push('class="' + _ + '"'), e = e.join(" "), y.push("<tr " + e + ">" + i.join("") + "</tr>"), h.push("<tr " + e + ">" + d.join("") + "</tr>"), f.push("<tr " + e + ">" + r.join("") + "</tr>"))
            ...
            return x.cache[a.key] = d, a.layTotal[0 == d.length ? "addClass" : "removeClass"](y), a.layPage[i.page || i.pagebar ? "removeClass" : "addClass"](R), a.layPage.find(O)[!i.page || 0 == n || 0 === d.length && 1 == l ? "addClass" : "removeClass"](y), 0 === d.length ? a.errorView(i.text.none) : (a.layFixLeft.removeClass(R), o ? u() : (u(), a.renderTotal(d, t), a.layTotal && a.layTotal.removeClass(R), void (i.page && (i.page = p.extend({
            ...
            var a, e, l, t, n, o, d, r = this, c = r.config, s = "all" === i.index, u = "array" === layui.type(i.index),
                y = s || u;
            y && (r.layBox.addClass(I), "radio" === i.type) || (u && (a = {}, layui.each(i.index, function (e, t) {
                a[t] = !0
                ...
                return i.index[e]
            } : '[data-index="' + i.index + '"]'), i = p.extend({type: "checkbox"}, i), l = x.cache[r.key], t = "checked" in i, n = function (e) {
                return "radio" === i.type || (t ? i.checked : !e)
            }, e.each(function () {
                var e = p(this), t = e.attr("data-index"), a = l[t];
                t && "array" !== layui.type(a) && !a[c.disabledName] && (a = a[c.checkName] = n(e.hasClass(_)), e.toggleClass(_, !!a), "radio" === i.type) && (o = t, e.siblings().removeClass(_))
            ...
            }[i.type] || "checkbox") + '"]:not(:disabled)')).last()).closest(z), ("radio" === i.type && d.hasClass(R) ? s.first() : s).prop("checked", n(u.prop("checked"))), r.syncCheckAll(), y && setTimeout(function () {
            ...
            e.layFixed.find(E).css("height", t.height() >= n ? n : "auto").scrollTop(e.layMain.scrollTop()), e.layFixRight[x.cache[e.key] && x.cache[e.key].length && 0 < l ? "removeClass" : "addClass"](R), e.layFixRight.css("right", a - 1)
        }, n.prototype.updateRow = function (e, i) {
            var r = this, c = ".layui-table-cell", e = "array" === layui.type(e) ? e : [e], s = x.cache[r.key] || [];
            layui.each(e, function (e, t) {
                var a, l, n, o, d;
                a = t.index, l = t.data, n = t.related, o = s[a] || {}, d = r.layBody.find('tr[data-index="' + a + '"]'), layui.each(l, function (e, t) {
                    ...
                    (i in l || ("function" == typeof n ? n(i, e) : n) && (t.templet || t.toolbar)) && (i = (e = d.children('td[data-field="' + i + '"]')).children(c), a = o[t.field], i.html(C.call(r, {
                        item3: t,
                        content: a,
                        tplData: p.extend({LAY_COL: t}, o)
            ...
            var c = this, s = c.config, o = s.elem.attr("lay-filter"), e = c.layHeader.find("th"), u = ".layui-table-cell",
                d = p("body"), r = {}, y = (c.layTool.on("click", "*[lay-event]", function (e) {
                    var i = p(this), a = i.attr("lay-event"), l = x.cache[s.id], n = function (e) {
                        var t = p(e.list), a = p('<ul class="' + H + '"></ul>');
                        a.html(t), s.height && a.css("max-height", s.height - (c.layTool.outerHeight() || 50)), i.find("." + H)[0] || i.append(a), c.renderForm(), a.on("click", function (e) {
                            layui.stope(e)
                        }), e.done && e.done(a, t)
                    };
                    layui.stope(e), F.trigger("table.tool.panel.remove"), f.close(c.tipsIndex), layui.each(s.defaultToolbar, function (e, t) {
                    ...
                    var t = p(this), a = t.attr("lay-event"), t = t.closest("th").data("key"), t = c.col(t);
                    ...
                    t.data("unresize") || k.eventMoveElem || (r.allowResize = t.width() - e <= 10, d.css("cursor", r.allowResize ? "col-resize" : ""))
                }).on("mouseleave", function () {
                    p(this);
                    k.eventMoveElem || (r.allowResize = !1, d.css("cursor", ""))
                }).on("mousedown", function (e) {
                    var t, a = p(this);
                    ...
                    }), a.data(S, r), k.eventMoveElem = a)
                }), k.docEvent || F.on("mousemove", function (e) {
                    var t, a;
                    k.eventMoveElem && (t = k.eventMoveElem.data(S) || {}, k.eventMoveElem.data("resizing", 1), e.preventDefault(), t.rule) && (e = t.ruleWidth + e.clientX - t.offset[0], a = k.eventMoveElem.closest("." + D).attr(N), a = w(a)) && ((e = e < t.minWidth ? t.minWidth : e) > t.maxWidth && (e = t.maxWidth), t.rule.style.width = e + "px", a.setGroupWidth(k.eventMoveElem), f.close(c.tipsIndex))
                }).on("mouseup", function (e) {
                    var t, a, i, l, n;
                    k.eventMoveElem && (i = (t = k.eventMoveElem).closest("." + D).attr(N), a = w(i)) && (i = t.data("key"), l = a.col(i), n = a.config.elem.attr("lay-filter"), r = {}, d.css("cursor", ""), a.scrollPatch(), t.removeData(S), delete k.eventMoveElem, a.cssRules(i, function (e) {
                    ...
                    c.sort({field: t, type: "asc" === i ? "desc" : "desc" === i ? null : "asc", fromEvent: !0})
                }).find(A + " .layui-edge ").on("click", function (e) {
                    var t = p(this), a = t.index(), t = t.parents("th").eq(0).data("field");
                    layui.stope(e), 0 === a ? c.sort({field: t, type: "asc", fromEvent: !0}) : c.sort({
                        field: t,
                        type: "desc",
                        fromEvent: !0
                    })
                }), c.commonMember = function (e) {
                    var a = p(this).parents("tr").eq(0).data("index"), t = c.layBody.find('tr[data-index="' + a + '"]'),
                        i = (x.cache[c.key] || [])[a] || {}, l = {
                            tr: t, config: s, data: x.clearCacheKey(i), dataCache: i, index: a, del: function () {
                    ...
                    t[0].disabled || (n ? c.setRowChecked({index: "all", checked: l}) : c.setRowChecked({
                        index: i,
                        checked: l
                    }), layui.stope(e), layui.event.call(t[0], T, "checkbox(" + o + ")", y.call(t[0], {
                        checked: l,
                        type: n ? "all" : "one",
                        getCol: function () {
                    ...
                    var a = p(this), i = a.parent(), l = i.data("key"), n = c.col(l), o = i.parent().data("index"),
                        d = i.children(u), i = "layui-table-cell-c", r = p('<i class="layui-icon layui-icon-up ' + i + '">');
                    "tips" === (t = t || n.expandedMode || s.cellExpandedMode) ? c.tipsIndex = f.tips(['<div class="layui-table-tips-main" style="margin-top: -' + (d.height() + 23) + "px;" + ("sm" === s.size ? "padding: 4px 15px; font-size: 12px;" : "lg" === s.size ? "padding: 14px 15px;" : "") + '">', d.html(), "</div>", '<i class="layui-icon layui-table-tips-c layui-icon-close"></i>'].join(""), d[0], {
                        ...
                        var t = e.style.width, a = n.expandedWidth || s.cellExpandedWidth;
                        a < parseFloat(t) && (a = parseFloat(t)), r.data("cell-width", t), e.style.width = a + "px", setTimeout(function () {
                            c.scrollPatch()
                        })
                    }), c.setRowActive(o, j), d.next("." + i)[0] || d.after(r), r.on("click", function () {
                        var t = p(this);
                        c.setRowActive(o, [j, M].join(" "), !0), c.cssRules(l, function (e) {
                    ...
                    c.setRowActive(i), layui.event.call(this, T, (e || "tool") + "(" + o + ")", y.call(this, {
            ...
            c.layBody.on("click", "*[lay-event]", function (e) {
                ...
                c.layHeader.scrollLeft(t), c.layTotal.scrollLeft(t), c.layFixed.find(E).scrollTop(e), f.close(c.tipsIndex)
            }), c.layFixed.find(E).on("mousewheel DOMMouseScroll", function (e) {
                var t = e.originalEvent.wheelDelta || -e.originalEvent.detail, a = c.layMain.scrollTop();
    ...
    x.eachCols = function (e, a, i) {
        ...
        return layui.each(e, function (e, t) {
            "array" === layui.type(t) || t[x.config.disabledName] ? i++ : t[x.config.checkName] && (a++, t[x.config.disabledName] || l.push(x.clearCacheKey(t)))
        ...
        var i = (a = "object" == typeof a ? a : (i = {}, a && (i.type = a), i)).type || "csv", o = k.that[e],
            l = k.config[e] || {}, n = {csv: "text/csv", xls: "application/vnd.ms-excel"}[i],
            d = document.createElement("a");
        if (b.ie) return g.error("IE_NOT_SUPPORT_EXPORTS");
        var r, c, s, u, y = l.tree && l.tree.view;
        if (y) try {
            t = p.extend(!0, [], x.cache[e]), t = function h(e) {
        ...
        d.href = "data:" + n + ";charset=utf-8,\ufeff" + encodeURIComponent((r = [], c = [], s = [], u = {}, layui.each(t, function (i, l) {
            ...
            "object" == typeof e ? (layui.each(e, function (e, t) {
                ...
                var a;
                !1 === t.ignoreExport || t.field && "normal" == t.type ? t.hide && !1 !== t.ignoreExport || !0 === t.ignoreExport ? 0 == i && (u[t.field] = !0) : ((a = l[t.field]) !== undefined && null !== a || (a = ""), 0 == i && r.push(t.fieldTitle || t.title || t.field || ""), a = (a = C.call(o, {
                    item3: t,
                    content: a,
                    tplData: l,
                    text: "text",
...
layui.define(["table"], function (e) {
    "use strict";
    var A = layui.$, x = layui.form, P = layui.table, y = layui.hint(), B = {
            config: {}, on: P.on, eachCols: P.eachCols, index: P.index, set: function (e) {
                var t = this;
                return t.config = A.extend({}, t.config, e), t
            }, resize: P.resize, getOptions: P.getOptions, hideCol: P.hideCol, renderData: P.renderData
        }, i = function () {
        ...
        }, F = "lay-table-id", L = "layui-hide", s = ".layui-table-body", q = ".layui-table-main",
        R = ".layui-table-fixed-l", Y = ".layui-table-fixed-r", l = "layui-table-checked", h = "layui-table-tree",
        z = "LAY_DATA_INDEX", m = "LAY_DATA_INDEX_HISTORY", p = "LAY_PARENT_INDEX", b = "LAY_CHECKBOX_HALF",
        H = "LAY_EXPAND", X = "LAY_HAS_EXPANDED", V = "LAY_ASYNC_STATUS", n = ["all", "parent", "children", "none"],
        t = /<[^>]+?>/, f = ["flexIconClose", "flexIconOpen", "iconClose", "iconOpen", "iconLeaf", "icon"],
        a = function (e) {
            var t = this;
            ...
            var r = j(d), o = ("reloadData" !== e && (r.status = {expand: {}}), A.extend(!0, {}, r.getOptions(), a)),
                n = o.tree, c = n.customName.children, i = n.customName.id,
            ...
            "reloadData" === e && "fixed" === o.scrollPos && (r.scrollTopCache = r.config.elem.next().find(s).scrollTop()), o.url ? e && (!l || l.mod) || (a.parseData = function () {
                ...
                var e, t = arguments, a = t[3], n = "renderData" === a, i = (n || delete r.isExpandAll, this.elem.next()),
                    l = (r.updateStatus(null, {LAY_HAS_EXPANDED: !1}), g(d, c), i.find('[name="layTableCheckbox"][lay-filter="layTableAllChoose"]'));
    ...
    a.prototype.init = function () {
        ...
        var e = this.getOptions(), n = e.tree.customName.id, i = "", e = B.getData(e.id, !0);
        ...
        var n = this.getOptions(), i = n.tree, n = n.id, n = P.cache[n], l = n[e];
    ...
    a.prototype.initData = function (e, t) {
        var a = this.getOptions(), n = a.tree, a = a.id, n = (e = e || this.getTableData(), n.customName),
            i = n.isParent, l = n.children, d = function (e, a) {
                layui.each(e, function (e, t) {
    ...
    var r, U = function (e, t, a) {
        ...
        var e = t.trElem, d = t.tableViewElem || e.closest(".layui-table-view"), r = t.tableId || d.attr(F),
            o = t.options || P.getOptions(r), e = t.dataIndex || e.attr("lay-data-index"), c = j(r), u = o.tree || {},
        ...
        var m = y[X], b = d.find('tr[lay-data-index="' + e + '"]'), g = b.find(".layui-table-tree-flexIcon"),
        ...
        if (v !== undefined && (c.status.expand[v] = x), null !== h) {
            ...
            if (x) if (m) {
                ...
                if (m.enable && y[f] && !y[V]) return y[V] = "loading", g.html('<i class="layui-icon layui-icon-loading layui-anim layui-anim-loop layui-anim-rotate"></i>'), N = function (e) {
                    ...
                    headers: _ || {},
                    success: function (e) {
                        (e = "function" == typeof k ? k.call(o, e) || e : e)[w.statusName] != w.statusCode ? (y[V] = "error", g.html('<i class="layui-icon layui-icon-refresh"></i>')) : N(e[w.dataName])
                    },
                    error: function (e, t) {
        ...
        var t = this.getOptions().tree || {}, a = e.scopeEl, n = e.isExpand, e = e.isParent;
        ...
        var l = this, n = l.getOptions(), d = n.elem.next(), i = (d.hasClass(h) || d.addClass(h), n.id),
            r = n.tree || {}, o = (r.data, r.view || {}), c = r.customName || {}, u = c.isParent,
            s = (d.attr("lay-filter"), l),
            f = ((t = t || 0) || (d.find(".layui-table-body tr:not([data-level])").attr("data-level", t), layui.each(P.cache[i], function (e, t) {
                d.find('.layui-table-main tbody tr[data-level="0"]:eq(' + e + ")").attr("lay-data-index", t[z]), d.find('.layui-table-fixed-l tbody tr[data-level="0"]:eq(' + e + ")").attr("lay-data-index", t[z]), d.find('.layui-table-fixed-r tbody tr[data-level="0"]:eq(' + e + ")").attr("lay-data-index", t[z])
        ...
        var t = n.config.id, i = j(t), a = n.data = B.getNodeDataByIndex(t, n.index), l = a[z],
            d = (n.dataIndex = l, n.update);
        n.update = function () {
            var e = arguments, t = (A.extend(i.getNodeDataByIndex(l), e[0]), d.apply(this, e)),
        ...
        var n = j(e);
        if (n) {
            var i, l = n.getOptions(), d = l.tree, r = d.customName.isParent, o = d.customName.children,
                c = l.elem.next(), u = [], s = P.cache[e],
        ...
        var a = j(e);
        if (a) {
            var n = a.getOptions(), i = n.tree, l = n.elem.next(), d = P.config.checkName,
                r = (t = t || {}).parentIndex, o = t.index, c = t.data, t = t.focus,
                u = (r = "number" === layui.type(r) ? r.toString() : r) ? a.getNodeDataByIndex(r) : null,
                o = "number" === layui.type(o) ? o : -1, c = A.extend(!0, [], layui.isArray(c) ? c : [c]);
            ...
            if (u) {
                ...
                l.find(f.map(function (e) {
                    return 'tr[lay-data-index="' + e[z] + '"]'
                }).join(",")).remove(), a.initData(), u[X] = !1, u[V] = "local", J({trElem: l.find('tr[lay-data-index="' + r + '"]')}, !0)
            } else {
                ...
                -1 == r ? y.find('tr[data-level="0"][data-index="0"]')[0] ? (y.find('tr[data-level="0"][data-index="0"]').before(h.trs), n.find('tr[data-level="0"][data-index="0"]').before(h.trs_fixed), f.find('tr[data-level="0"][data-index="0"]').before(h.trs_fixed_r)) : (y.find("tbody").prepend(h.trs), n.find("tbody").prepend(h.trs_fixed), f.find("tbody").prepend(h.trs_fixed_r)) : -1 === o ? (y.find("tbody").append(h.trs), n.find("tbody").append(h.trs_fixed), f.find("tbody").append(h.trs_fixed_r)) : (r = p[0][m], y.find('tr[data-level="0"][data-index="' + r + '"]').before(h.trs), n.find('tr[data-level="0"][data-index="' + r + '"]').before(h.trs_fixed), f.find('tr[data-level="0"][data-index="' + r + '"]').before(h.trs_fixed_r)), layui.each(P.cache[e], function (e, t) {
        ...
        }) : r = !1, o = o && !r, x.render(i.find('input[name="layTableCheckbox"][lay-filter="layTableAllChoose"]').prop({
            checked: r,
            indeterminate: o
        })), r)
        ...
        return !(a[b] = !1) === n ? a[t].length ? layui.each(a[t], function (e, t) {
            ...
            t[l] && i++
        }), n = a[t].length ? a[t].length === i : a[l], a[b] = !n && 0 < i), a[l] = n, d.push(A.extend({}, a)), d = a[p] ? d.concat(this.updateParentCheckStatus(P.cache[e][a[p]], n)) : d
    }, function (e, t, a) {
        ...
        if (a) {
            ...
            a && (n.updateStatus(null, function (e) {
                var t;
                e[u] && (t = r.find('tr[lay-data-index="' + e[z] + '"] input[type="radio"][lay-type="layTableRadio"]'), e[u] = !1, n.setRowCheckedClass(t.closest("tr"), !1), x.render(t.prop("checked", !1)))
...
layui.define(["laytpl", "form"], function (e) {
    ...
    var d = layui.$, n = layui.laytpl, t = layui.form, a = "transfer", i = {
        ...
        }, s = "layui-hide", u = "layui-btn-disabled", c = "layui-none", r = "layui-transfer-box",
        h = "layui-transfer-header", o = "layui-transfer-search", f = "layui-transfer-data", y = function (e) {
    ...
    v.prototype.config = {
        ...
        var e = this, t = e.config, a = e.elem = d(n(p, {open: "{{", close: "}}"}).render({data: t, index: e.index})),
            i = t.elem = d(t.elem);
        ...
        c = c || {}, r.layBox.each(function (e) {
            var t = d(this), a = t.find("." + f), t = t.find("." + h).find('input[type="checkbox"]'),
        ...
        var a, i = this, n = i.config, l = i.layBox.eq(e), c = [],
        ...
        n.elem.on("click", 'input[lay-filter="layTransferCheckbox"]+', function () {
            var e = d(this).prev(), t = e[0].checked, a = e.parents("." + r).eq(0).find("." + f);
            ...
            var t = d(this), a = t.children('input[type="checkbox"]'), i = t.parent().parent().data("index");
            ...
            var i = this.value, e = d(this).parents("." + o).eq(0).siblings("." + f), t = e.children("li"),
                t = (t.each(function () {
                    var e = d(this), t = e.find('input[type="checkbox"]'), a = t[0].title,
...
layui.define(["jquery", "lay"], function (e) {
    "use strict";
    var o = layui.$, l = layui.lay, t = (layui.hint(), layui.device(), {
        ...
        }), r = "carousel", s = "layui-this", u = "layui-carousel-left", c = "layui-carousel-right",
        m = "layui-carousel-prev", h = "layui-carousel-next", a = "layui-carousel-arrow", d = "layui-carousel-ind",
        n = function (e) {
            var n = this;
    ...
    n.prototype.config = {
        ...
        var e = this, n = e.config, i = o(n.elem);
        ...
        var e = this, n = e.config, i = e.elemItem.length;
        n.autoplay && (clearInterval(e.timer), 1 < i) && (e.timer = setInterval(function () {
            e.slide()
        }, n.interval))
    }, n.prototype.arrow = function () {
        var n = this, e = n.config, i = n.elemItem.length,
        ...
        var n, e = this, i = e.config, t = e.elemItem.length,
        ...
        var i = this, t = i.elemItem, a = t.length, o = i.config, l = o.index, d = o.elem.attr("lay-filter");
        ...
        e.elem.data("haveEvents") || (e.elem.on("mouseenter touchstart", function () {
            ...
            onTouchEnd: function (e, n) {
                var i = Date.now() - n.timeStart, n = a ? n.distanceY : n.distanceX;
...
layui.define("jquery", function (o) {
    "use strict";
    var w = layui.$, l = function (o) {
    };
    l.prototype.load = function (o) {
        var i, n, r, l, c, m, e, t, a, f, s, u, p, d, y, h = this, g = 0, v = w((o = o || {}).elem);
        if (v[0]) return c = w(o.scrollElem || document), m = "mb" in o ? o.mb : 50, e = !("isAuto" in o) || o.isAuto, t = o.moreText || "\u52a0\u8f7d\u66f4\u591a", a = o.end || "\u6ca1\u6709\u66f4\u591a\u4e86", f = "top" === (o.direction || "bottom"), h._cleanup(v, c), s = o.scrollElem && o.scrollElem !== document, p = w('<div class="layui-flow-more"><a href="javascript:;">' + (u = "<cite>" + t + "</cite>") + "</a></div>"), v.find(".layui-flow-more")[0] || v[f ? "prepend" : "append"](p), d = function (o, l) {
            var e = s ? c.prop("scrollHeight") : document.documentElement.scrollHeight, t = c.scrollTop();
            o = w(o), p[f ? "after" : "before"](o), (l = 0 == l || null) ? p.html(a) : p.find("a").html(u), n = l, i = null, r && r(), f && (o = s ? c.prop("scrollHeight") : document.documentElement.scrollHeight, 1 === g ? c.scrollTop(o) : 1 < g && c.scrollTop(t + (o - e)))
        }, (y = function () {
            i = !0, p.find("a").html('<i class="layui-anim layui-anim-rotate layui-anim-loop layui-icon ">&#xe63e;</i>'), "function" == typeof o.done && o.done(++g, d)
        ...
        var l, m = this, a = 0, f = w((o = o || {}).scrollElem || document), s = o.elem || "img",
            n = "top" === (o.direction || "bottom"), u = o.scrollElem && o.scrollElem !== document,
            p = function (l, o) {
                ...
                var e = (u ? l || f : w(window)).height(), t = f.scrollTop(), i = t + e;
                if (m.lazyimg.elem = w(s), o) p(o, e); else for (var n = 0; n < m.lazyimg.elem.length; n++) {
                    var r = m.lazyimg.elem.eq(n), c = u ? r.offset().top - f.offset().top + t : r.offset().top;
